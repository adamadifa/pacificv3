...
<tr>
    ...
    <td style="width:100px" class="text-right">
        <input type="hidden" style="text-align:right" value="<?php if (!empty($jmldus)) {
            echo $jmldus;
        } ?>" id="jmldus" name="jmldus[]" class="form-control"
            data-error=".errorTxt19" />
        {{ !empty($jmldus) ? rupiah($jmldus) : '' }}
    </td>
    <td style="width:50px"><?php echo $b->satuan; ?></td>
    <td style="width:100px" class="text-right">
        <input type="hidden" style="text-align:right" value="<?php if (!empty($jmlpack)) {
            echo $jmlpack;
        } ?>" id="jmlpack" name="jmlpack[]" class="form-control"
            data-error=".errorTxt19" />
    ...
    <td style="width:100px" class="text-right">
        <input type="hidden" style="text-align:right" value="<?php if (!empty($jmlpcs)) {
            echo $jmlpcs;
        } ?>" id="jmlpcs" name="jmlpcs[]" class="form-control"
            data-error=".errorTxt19" />
