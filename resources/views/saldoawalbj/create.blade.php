        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Input Saldo Awal
                            {{ $jenis_bj == 'GS' ? 'Good Stok' : 'Bad Stok' }}</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/saldoawalgudangbahan/create">Input Saldo Awal
                                        {{ $jenis_bj == 'GS' ? 'Good Stok' : 'Bad Stok' }}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <table class="table table-border">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="6" style="text-align:center">Saldo Awal
                                            {{ $jenis_bj == 'GS' ? 'Good Stok' : 'Bad Stok' }}</th>
                                    </tr>
                                    <tr>
