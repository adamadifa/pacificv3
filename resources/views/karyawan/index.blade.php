...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                @endif
                                <a href="#" id="cekhabiskontrak" class="btn btn-danger"><i class="feather icon-user-x mr-1"></i>Karyawan Habis
                                    Kontrak</a>
                            </div>
                                            ...
                                            <div class="col-lg-2 col-sm-12">
                                                <div class="form-group">
                                                    <select name="id_perusahaan_search" id="id_perusahaan_search" class="form-control">
                                                        ...
                                                        <option value="MP" {{ Request('id_perusahaan_search') == 'MP' ? 'selected' : '' }}>
                                                            MP</option>
                                                        <option value="PCF" {{ Request('id_perusahaan_search') == 'PCF' ? 'selected' : '' }}>
                                                            PCF</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2 col-sm-12">
                                                <div class="form-group">
                                                    <select name="grup_search" id="grup_search" class="form-control">
                                                        ...
                                                        @foreach ($group as $d)
                                                            <option {{ Request('grup_search') == $d->id ? 'selected' : '' }} value="{{ $d->id }}">
                                                                {{ $d->nama_group }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-2 col-sm-12">
                                                <div class="form-group">
                                                    <select name="status_aktif_karyawan" id="status_aktif_karyawan" class="form-control">
                                                        ...
                                                        <option value="1" {{ Request('status_aktif_karyawan') == '1' ? 'selected' : '' }}>
                                                            Aktif</option>
                                                        <option value="0" {{ Request('status_aktif_karyawan') === '0' ? 'selected' : '' }}>
                                                            Non Aktif</option>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <tr style="background-color:{{ $d->status_aktif == 0 ? '#ff695e' : '' }}">
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a href="#" class="uploadktp" nik="{{ Crypt::encrypt($d->nik) }}"><i
                                                            ...
                                                            @if (in_array($level, $karyawan_edit))
                                                                <a class="ml-1 edit" nik="{{ Crypt::encrypt($d->nik) }}" href="#"><i
                                                                        class="feather icon-edit success"></i></a>
                                                            @endif
                                                            <a href="/karyawan/{{ Crypt::encrypt($d->nik) }}/show" class="ml-1"><i
                                                            ...
                                                            @if (in_array($level, $karyawan_pinjaman))
                                                                ...
                                                                @if ($level == 'manager audit')
                                                                    <a href="#" nik="{{ Crypt::encrypt($d->nik) }}" class="ajukanpinjaman"><i
                                                                            class="feather icon-external-link primary ml-1"></i></a>

                                                                    <a href="#" nik="{{ Crypt::encrypt($d->nik) }}" class="ajukankasbon"><i
                                                   ...
                                                   @endif --}}
                                                    ...
                                                    @endif --}}
                                                            ...
                                                            @if (Auth::user()->id == 57 || Auth::user()->id == 1 || Auth::user()->id == 90)
                                                                <a href="#" nik="{{ Crypt::encrypt($d->nik) }}" class="ajukanpinjamannonpjp"><i
    ...
    <div class="modal fade text-left" id="mdlajukanpinjamannonpjp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade text-left" id="mdluploadktp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
