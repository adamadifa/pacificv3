...
@section('content')
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        ?>
                                            <option {{ Request('bulan') == $i ? 'selected' : '' }} value="<?php echo $i; ?>"><?php echo $bulan[$i]; ?>
                                            </option>
                                            <?php
                                        }
                                        ?>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        ?>
                                            <option {{ Request('tahun') == $thn ? 'selected' : '' }} value="<?php echo $thn; ?>"><?php echo $thn; ?>
                                            </option>
                                            <?php
                                        }
                                        ?>
                                ...
                                <tbody>
                                    @foreach ($pinjamanpotongangaji as $d)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="#" class="detail info" kode_potongan="{{ $d->kode_potongan }}"><i
                                                            class="feather icon-file-text"></i></a>
                                                    @if ($loop->last)
                                                        <form method="POST" class="deleteform"
                                                            action="/pembayaranpinjaman/{{ Crypt::encrypt($d->kode_potongan) }}/deletegenerate">
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="modal fade text-left" style="z-index: 1052 !important" id="mdldetailpembayaran" tabindex="-1" role="dialog"
