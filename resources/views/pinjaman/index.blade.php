...
@section('content')
                    ...
                    <form action="/pinjaman">
                        ...
                        @if (Auth::user()->kode_cabang == 'PCF' && in_array($level, $level_search))
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        <x-inputtext label="Nama Karyawan" value="{{ Request('nama_karyawan') }}" field="nama_karyawan"
                                ...
                                @foreach ($pinjaman as $d)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                @if (in_array(Auth::user()->id, $user_approve))
                                                    <a href="#" class="approve" no_pinjaman="{{ $d->no_pinjaman }}"><i
                                        ...
                                        @endif --}}
                                                ...
                                                <a class="ml-1 show" no_pinjaman="{{ $d->no_pinjaman }}" href="#"><i
                                                        class="feather icon-file-text info"></i></a>
                                                <a href="/pinjaman/{{ Crypt::encrypt($d->no_pinjaman) }}/cetakformulir" target="_blank"
                                                    class="ml-1"><i class="feather icon-printer text-primary"></i></a>


                                                @if ($d->status == null && Auth::user()->id == $d->id_user)
                                                    <a class="ml-1 edit" no_pinjaman="{{ $d->no_pinjaman }}" href="#"><i
    ...
    <div class="modal fade text-left" style="z-index: 1052 !important" id="mdlinputbayarpinjaman" tabindex="-1" role="dialog"
