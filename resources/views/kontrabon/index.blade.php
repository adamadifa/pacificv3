                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/kontrabon">
                            <div class="row">
                                <div class="col-6">
                                    <x-inputtext label="No. Kontrabon" value="{{ Request('no_kontrabon') }}" field="no_kontrabon"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a class="ml-1" target="_blank" href="/kontrabon/{{ Crypt::encrypt($d->no_kontrabon) }}/cetak"><i
                                                            class=" feather icon-printer primary"></i></a>

                                                    <a class="ml-1 detailkontrabon" href="#"
                                                        no_kontrabon="{{ Crypt::encrypt($d->no_kontrabon) }}"><i
                                                    ...
                                                    @if (in_array($level, $kontrabon_edit_hapus))
                                                        @if (empty($d->tglbayar) && $d->kategori != 'TN')
                                                            <a class="ml-1" href="/kontrabon/{{ \Crypt::encrypt($d->no_kontrabon) }}/edit"><i
                                                                    class="feather icon-edit success"></i></a>
                                                            <form method="POST" class="deleteform"
                                                                action="/kontrabon/{{ Crypt::encrypt($d->no_kontrabon) }}/delete">
                                                                @csrf
                                                                @method('DELETE')
                                                    ...
                                                    @if (in_array($level, $kontrabon_approve))
                                                        ...
                                                        @if (empty($d->tglbayar))
                                                            @if ($d->status == 1)
                                                                <a href="/kontrabon/{{ Crypt::encrypt($d->no_kontrabon) }}/cancelkontrabon"
                                                                    class="danger ml-1"><i class="fa fa-close"></i></a>
                                                            @else
                                                                @if ($d->kategori != 'TN')
                                                                    <a href="/kontrabon/{{ Crypt::encrypt($d->no_kontrabon) }}/approvekontrabon"
                                                    ...
                                                    @if (in_array($level, $kontrabon_proses))
                                                        @if (empty($d->tglbayar))
                                                            @if ($d->status == 1)
                                                                <a class="ml-1 proseskontrabon" href="#"
                                                                    no_kontrabon="{{ Crypt::encrypt($d->no_kontrabon) }}"><i
                                                                        class=" feather icon-external-link success"></i></a>
                                                            @else
                                                                @if ($d->kategori != 'TN')
                                                                    <span class="badge bg-warning ml-1"><i class="fa fa-history mr-1"></i>Waiting
                                                                        Approval</span>
                                                                @else
                                                                    <a class="ml-1 proseskontrabon" href="#"
                                                                        no_kontrabon="{{ Crypt::encrypt($d->no_kontrabon) }}"><i
                                                            ...
                                                            @endif
                                                        @else
                                                            <form method="POST" class="cancelkontrabon"
                                                                action="/kontrabon/{{ Crypt::encrypt($d->no_kontrabon) }}/batalkankontrabon">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            <a class="ml-1 editkontrabon" href="#"
                                                                no_kontrabon="{{ Crypt::encrypt($d->no_kontrabon) }}"><i
                                                                    class="feather icon-edit success"></i></a>
                                                        @endif
                                                    @endif
