<form action="/angkutan/{{ Crypt::encrypt($angkutan->no_surat_jalan) }}/update" method="post" id="frmEdit">
    ...
    <div class="row">
        <div class="col-12">
            <x-inputtext label="No. Surat jalan" field="no_surat_jalan" value="{{ $angkutan->no_surat_jalan }}"
                icon="fa fa-barcode" />
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                <select name="tujuan" id="tujuan" class="form-control tujuan select2">
                    ...
                    <option {{ $angkutan->tujuan == 'PURWOKERTO' ? 'selected' : '' }} value="PURWOKERTO">PURWOKERTO
                    </option>
                    ...
                    <option {{ $angkutan->tujuan == 'PEKALONGAN' ? 'selected' : '' }} value="PEKALONGAN">PEKALONGAN
                    </option>
                    <option {{ $angkutan->tujuan == 'SURABAYA COL DESEL' ? 'selected' : '' }}
                        value="SURABAYA COL DESEL">SURABAYA COL DESEL</option>
                    <option {{ $angkutan->tujuan == 'SURABAYA TORONTON' ? 'selected' : '' }} value="SURABAYA TORONTON">
                        SURABAYA TORONTON</option>
                    ...
                    <option {{ $angkutan->tujuan == 'TANGERANG' ? 'selected' : '' }} value="TANGERANG">TANGERANG
                    </option>
                    <option {{ $angkutan->tujuan == 'KLATEN' ? 'selected' : '' }} value="KLATEN">KLATEN</option>
                    <option {{ $angkutan->tujuan == 'KALIPUCANG' ? 'selected' : '' }} value="KALIPUCANG">KALIPUCANG
                    </option>
                    <option {{ $angkutan->tujuan == 'TASIKMALAYA' ? 'selected' : '' }} value="TASIKMALAYA">TASIKMALAYA
                    </option>
                    <option {{ $angkutan->tujuan == 'PURWAKARTA' ? 'selected' : '' }} value="PURWAKARTA">PURWAKARTA
                    </option>
                    <option {{ $angkutan->tujuan == 'PEMALANG' ? 'selected' : '' }} value="PEMALANG">PEMALANG</option>
                    <option {{ $angkutan->tujuan == 'BEKASI' ? 'selected' : '' }} value="BEKASI">BEKASI</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <x-inputtext label="Tarif" field="tarif" icon="feather icon-dollar-sign"
                value="{{ rupiah($angkutan->tarif) }}" right />
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <x-inputtext label="Tepung" field="tepung" icon="feather icon-dollar-sign"
                value="{{ rupiah($angkutan->tepung) }}" right />
        </div>
    </div>

    <div class="row">
        <div class="col-12">
            <x-inputtext label="BS" field="bs" icon="feather icon-dollar-sign"
                value="{{ rupiah($angkutan->bs) }}" right />
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                <select name="angkutan" id="angkutan" class="form-control select2">
                    ...
                    <option {{ $angkutan->angkutan == 'ANGKUTAN KS' ? 'selected' : '' }} value="KS">ANGKUTAN KS
                    </option>
                    <option {{ $angkutan->angkutan == 'KWN SUAKA' ? 'selected' : '' }} value="KWN SUAKA">ANGKUTAN KAWAN
                        SWAKA</option>
                    ...
                    <option {{ $angkutan->angkutan == 'WAWAN' ? 'selected' : '' }} value="WAWAN">ANGKUTAN WAWAN
                    </option>
                    <option {{ $angkutan->angkutan == 'RTP' ? 'selected' : '' }} value="RTP">ANGKUTAN RTP</option>
                    <option {{ $angkutan->angkutan == 'KWN GOBRAS' ? 'selected' : '' }} value="KWN GOBRAS">ANGKUTAN KWN
                        GOBRAS</option>
                    ...
                    <option {{ $angkutan->angkutan == 'MANDIRI' ? 'selected' : '' }} value="MANDIRI">ANGKUTAN MANDIRI
                    </option>
                    <option {{ $angkutan->angkutan == 'GS' ? 'selected' : '' }} value="GS">ANGKUTAN GS</option>
                    <option {{ $angkutan->angkutan == 'CV TRESNO' ? 'selected' : '' }} value="CV TRESNO">ANGKUTAN CV
                        TRESNO</option>
                    ...
                    <option {{ $angkutan->angkutan == 'MITRA KOMANDO' ? 'selected' : '' }} value="MITRA KOMANDO">
                        ANGKUTAN MITRA KOMANDO</option>
                    <option {{ $angkutan->angkutan == 'ARP MANDIRI' ? 'selected' : '' }} value="ARP MANDIRI">ANGKUTAN
                        ARP MANDIRI</option>
                    <option {{ $angkutan->angkutan == 'CAHAYA BIRU' ? 'selected' : '' }} value="CAHAYA BIRU">ANGKUTAN
                        CAHAYA BIRU</option>
                </select>
            </div>
        </div>
