        ...
        <tbody>
            ...
            @foreach ($rekapbg as $key => $r)
                ...
                <tr style="font-size:12px">
                    ...
                    <td align="right" style="font-weight:bold"><?php if (!empty($r->jumlah)) {
                        echo rupiah($r->jumlah);
                    } ?></td>
                    <td><?php if (!empty($tglcair)) {
                        echo DateToIndo2($tglcair);
                    } ?></td>
                    <td align="right" style="font-weight:bold; background-color:#54bbd8"><?php if (!empty($girobc)) {
                        echo rupiah($girobc);
                    } ?></td>
                </tr>
                @php
            ...
            <tr style="font-size:12px" bgcolor="yellow">
                ...
                <th style="text-align:right"><?php if (!empty($totalgiroall)) {
                    echo rupiah($totalgiroall);
                } ?></th>
                <th></th>
                <th style="text-align:right"><?php if (!empty($totalgiroallbc)) {
                    echo rupiah($totalgiroallbc);
                } ?></th>
            </tr>
        </tbody>
    </table>
