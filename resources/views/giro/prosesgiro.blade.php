<form autocomplete="off" id="frmUpdategiro" method="POST" action="/giro/update">
    @csrf
    <input type="hidden" name="no_giro" value="{{ $giro->no_giro }}">
    <input type="hidden" id="statusgiro" name="statusgiro" value="{{ $giro->status }}">
    <input type="hidden" name="tgl_giro" value="{{ $giro->tgl_giro }}">
    <input type="hidden" name="tglcair" value="{{ $giro->tglcair }}">
    <input type="hidden" name="pelanggan" value="{{ $giro->nama_pelanggan }}">
    <input type="hidden" name="jenistransaksi" value="{{ $giro->jenistransaksi }}">
    <input type="hidden" name="kode_cabang" value="{{ $giro->kode_cabang }}">
    <table class="table">
        <tr>
            <td>No. Giro</td>
            <td>{{ $giro->no_giro }}</td>
        ...
        <tr>
            <td>Jumlah</td>
            <input type="hidden" name="jumlah" value="{{ $giro->jumlah }}">
            <td style="font-weight: bold">{{ rupiah($giro->jumlah) }}</td>
        </tr>
        <tr>
            <td>Jatuh Tempo</td>
            <input type="hidden" value="{{ $giro->tglcair }}" name="jatuhtempo">
...
<script>
    $(function() {
        ...
        $("#frmUpdategiro").submit(function(e) {
            var status = $("#statusaksi").val();
