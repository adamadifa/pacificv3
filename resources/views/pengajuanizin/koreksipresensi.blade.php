...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header">
                            @if (Auth::user()->pic_presensi == 1)
                                <a href="#" class="btn btn-primary" id="buatkoreksi"><i class="fa fa-plus mr-1"></i>
                                    Buat Pengajuan</a>
                            @endif
                                                    ...
                                                    <tbody>
                                                        @foreach ($pengajuan_izin as $d)
                                                            <tr>
                                                                ...
                                                                <td class="filterable-cell">{{ $d->nama_jadwal }}</td>
                                                                <td class="filterable-cell">{{ $d->jam_masuk }}</td>
                                                                <td class="filterable-cell">{{ $d->jam_pulang }}</td>
    ...
    <div class="modal fade text-left" id="mdlkoreksipresensi" tabindex="-1" role="dialog"
