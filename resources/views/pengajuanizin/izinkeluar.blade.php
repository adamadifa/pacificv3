...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <div class="row mb-1">
                                        <div class="col-12">
                                            <form action="/pengajuanizin/izinkeluar">
                                                <div class="row">
                                                    <div class="col-lg-6 col-sm-12">
                                                        <x-inputtext label="Dari" field="dari_search"
                                                            value="{{ Request('dari_search') }}"
                                                            icon="feather icon-calendar" datepicker />
                                                    </div>
                                                    <div class="col-lg-6 col-sm-12">
                                                        <x-inputtext label="Sampai" field="sampai_search"
                                                            value="{{ Request('sampai_search') }}"
                                                            icon="feather icon-calendar" datepicker />
                                                    </div>
                                                </div>
                                                @php
                                                ...
                                                @if (Auth::user()->kode_cabang == 'PCF' && in_array($level, $level_search))
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-sm-12">
                                                            <div class="form-group">
                                                                <x-inputtext label="Nama Karyawan"
                                                                    value="{{ Request('nama_karyawan') }}"
                                                                    field="nama_karyawan" icon="feather icon-user" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        @foreach ($pengajuan_izin as $d)
                                                            <tr>
                                                                ...
                                                                <td class="filterable-cell">
                                                                    <a href="/pengajuanizin/{{ Crypt::encrypt($d->kode_izin) }}/cetak"
                                                                        target="_blank">
                                                                        {{ $d->kode_izin }}
                                                                    </a>
                                                                </td>
                                                                <td class="filterable-cell">
                                                                    {{ date('d-m-Y', strtotime($d->dari)) }}</td>
                                                                ...
                                                                <td class="filterable-cell">{{ $d->jam_keluar }}</td>
                                                                <td class="filterable-cell">
                                                                    @if (empty($d->jam_masuk))
                                                                        <a href=" #" class="updatejammasuk"
                                                                            kode_izin="{{ $d->kode_izin }}"><i
                                                                                class="fa fa-history text-warning"></i></a>
                                                                    @else
                                                                        <a href="#" class="updatejammasuk"
                                                                            kode_izin="{{ $d->kode_izin }}">{{ $d->jam_masuk }}</a>
                                                                    @endif
                                                                </td>
                                                                <td class="filterable-cell">
                                                                    @if ($d->keperluan == 'P')
                                                                        <span class="badge bg-danger">Keperluan
                                                                            Pribadi</span>
                                                                        <br>
                                                                    @elseif($d->keperluan == 'K')
                                                                        <span class="badge bg-success">Keperluan
                                                                            Kantor</span>
                                                                        <br>
                                                                    @endif
                                                                ...
                                                                <td class="text-center filterable-cell">
                                                                    ...
                                                                    @php
                                                                        $jabatan = ['MANAGER', 'GENERAL MANAGER', 'ASST. MANAGER'];
                                                                    @endphp
                                                                ...
                                                                <td class="filterable-cell">
                                                                    <div class="btn-group" role="group"
                                                                        ...
                                                                        @else
                                                                            ...
                                                                            {{-- Jika Head Dept Sudah Approve dan HRD Belum Approve --}}
                                                                            @if (
                                                                                (!empty($d->head_dept) && empty($d->hrd)) ||
                                                                                    (empty($d->head_dept) && $d->kode_dept == 'HRD') ||
                                                                                    (empty($d->head_dept) && $d->nama_jabatan == 'GENERAL MANAGER'))
                                                                                <a href="#" class="approveizin"
                                                                                    kode_izin="{{ $d->kode_izin }}">
                                                                                    <i
                                                                                        class="feather icon-external-link text-primary"></i>
                                                                        ...
                                                                        @if (empty($d->status_approved) || $d->status_approved == 2)
                                                                            <form method="POST" class="deleteform"
                                                                                action="/pengajuanizin/{{ Crypt::encrypt($d->kode_izin) }}/delete">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <a href="#"
                                                                                    class="delete-confirm ml-1">
                                                                                    <i
                                                                                        class="feather icon-trash danger"></i>
                                                                                </a>
                                                                            </form>
                                                                        @endif
    ...
    <div class="modal fade text-left" id="mdlbuatizin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade text-left" id="mdlupdatejammasuk" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/pengajuanizin/updatejammasukkk" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <x-inputtext label="Jam Masuk Keluar Kantor" field="jam_masuk_kk"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button type="submit" name="submit" class="btn btn-primary btn-block"><i
                                            class="feather icon-refresh-ccw mr-1"></i>Update</button>
                                </div>
                            </div>
                        </div>
                    </form>
