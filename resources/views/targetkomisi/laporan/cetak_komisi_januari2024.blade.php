    ...
    <table class="datatable3">
        <thead>
            <tr>
                ...
                <th rowspan="2" colspan="2">PENJUALAN VS AVG</th>
                <th rowspan="2" colspan="2">CASHIN</th>
                <th rowspan="2" colspan="23">LJT</th>
            </tr>
            <tr>
                @foreach ($kategori_komisi as $d)
            ...
            @foreach ($komisi as $d)
                ...
                <tr>
                    ...
                    @foreach ($kategori_komisi as $k)
                        ...
                        <td style="background-color: #35ce35; text-align:center">
