...
@section('titlepage','Rekap Komisi')
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Rekap Komisi</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/rekapkomisi">Rekap Komisi</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="col-lg-9 col-sm-12">
                <div class="row">
                    <div class="col-lg-7 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="/rekapkomisi/cetak" method="POST" id="frmPenjualan" target="_blank">
                                    @csrf
