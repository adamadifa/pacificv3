    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Buku Besar</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/laporanaccounting/bukubesar">Buku Besar </a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="col-lg-9 col-sm-12">
                <div class="row">
                    <div class="col-lg-7 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="/laporanaccounting/bukubesar/cetak" method="POST" id="frmPembelian" target="_blank">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <select name="dari_akun" id="dari_akun" class="form-control select2">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <select name="sampai_akun" id="sampai_akun" class="form-control select2">
                                                    <option value="">Akun</option>
                                                    @foreach ($akun as $d)
                                                    <option value="{{ $d->kode_akun }}">{{ $d->kode_akun }} - {{ $d->nama_akun }}</option>
                                                    @endforeach
