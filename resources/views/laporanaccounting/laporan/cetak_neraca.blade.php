...
<body>
    ...
    <table class="datatable3">
        @foreach ($neraca as $key => $d)
        @php
        $nextkategori1 = @$neraca[$key + 1]->kategori_1;
        $nextkategori2 = @$neraca[$key + 1]->kategori_2;
        $nextkategori3 = @$neraca[$key + 1]->kategori_3;
        $nextlevel = @$neraca[$key + 1]->level;
        $level = $d->level;
