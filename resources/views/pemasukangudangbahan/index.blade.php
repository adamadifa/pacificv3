            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/pemasukangudangbahan">Data Barang Masuk</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-6">
            <div class="card">
                <div class="card-header">
                    <a href="/pemasukangudangbahan/create" class="btn btn-primary"><i class="fa fa-plus mr-1"></i> Tambah Data</a>
                </div>

                <div class="card-body">
                    <form action="/pemasukangudangbahan">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a class="ml-1" href="/pemasukangudangbahan/{{\Crypt::encrypt($d->nobukti_pemasukan)}}/edit"><i class="feather icon-edit success"></i></a>
                                            <a class="ml-1 detail" href="#" nobukti_pemasukan="{{ Crypt::encrypt($d->nobukti_pemasukan) }}"><i class=" feather icon-file-text info"></i></a>
                                            <form method="POST" class="deleteform" action="/pemasukangudangbahan/{{Crypt::encrypt($d->nobukti_pemasukan)}}/delete">
                                                @csrf
                                                @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 980px">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel18">Detail Pemasukan Gudang bahan</h4>
