                                            ...
                                            <div class="col-12">
                                                <div class="form-group  @error('kategori_salesman') error @enderror">
                                                    <select name="kategori_salesman" id="" class="form-control">
                                                        ...
                                                        <option @if (old('kategori_salesman') == 'TO') selected @endif
                                                            value="TO">TO</option>
                                                        <option @if (old('kategori_salesman') == 'CANVASER') selected @endif
                                                            value="CANVASER">CANVASER</option>
                                                        <option @if (old('kategori_salesman') == 'RETAIL') selected @endif
                                                            value="RETAIL">RETAIL</option>
                                                        <option @if (old('kategori_salesman') == 'MOTORIS') selected @endif
                                                            value="MOTORIS">MOTORIS</option>
                                                        <option @if (old('kategori_salesman') == 'TOCANVASER') selected @endif
                                            ...
                                            <div class="col-12">
                                                <div class="form-group  @error('status_aktif_sales') error @enderror">
                                                    <select name="status_aktif_sales" id="" class="form-control">
                                                        ...
                                                        <option @if (old('status_aktif_sales') == '1') selected @endif
                                                            value="1">AKTIF</option>
                                                        <option @if (old('status_aktif_sales') == '0') selected @endif
                                            ...
                                            <div class="col-12">
                                                <div class="form-group  @error('status_komisi') error @enderror">
                                                    <select name="status_komisi" id="" class="form-control">
                                                        ...
                                                        <option @if (old('status_komisi') == '1') selected @endif
                                                            value="1">AKTIF</option>
                                                        <option @if (old('status_komisi') == '0') selected @endif
                                                            value="0">NON AKTIF</option>
                                                    </select>
                                                    @error('status_komisi')
                                                        <div class="help-block">
