                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/pengeluarangudangbahan/create">Input Data Barang
                                        Keluar</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <x-inputtext field="nobukti_pengeluaran" label="Auto" icon="fa fa-barcode"
                                            readonly />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <x-inputtext field="tgl_pengeluaran" label="Tanggal Pemasukan"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <select name="kode_cabang" id="kode_cabang" class="form-control">
                                                ...
                                                @foreach ($cabang as $d)
                                                    <option value="{{ $d->kode_cabang . '|' . $d->nama_cabang }}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <a href="#" id="tambahbarang" class="btn btn-primary btn-block"><i
