...
@section('titlepage', 'Data Repact / Reject')
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{strtoupper($jenis_mutasi)}}</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/suratjalan">{{strtoupper($jenis_mutasi)}}</a>
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="content-body">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="/repackrejectgj/store" id="frm" method="POST">
                            @csrf
                            <input type="hidden" id="cektutuplaporan">
                            <input type="hidden" id="cektemp">
                            <input type="hidden" id="jenis_mutasi" name="jenis_mutasi" value="{{$jenis_mutasi}}">
                            <div class="row">
                                <div class="col-12">
                                    <x-inputtext field="no_mutasi_gudang" label="No. {{ucwords($jenis_mutasi)}}" icon="fa fa-barcode" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <table class="table table-hover-animation">
                                        ...
                                        <tbody id="loadrepackreject"></tbody>
                                    </table>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <table class="table table-hover-animation">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST" class="deleteform" action="/repackrejectgj/{{Crypt::encrypt($d->no_mutasi_gudang)}}/delete">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel18">Detail {{ucwords($jenis_mutasi)}}</h4>
...
<script>
    $(function() {
        ...
        function loaddetail(no_mutasi_gudang) {
            $("#loaddetail").load("/repackrejectgj/" + no_mutasi_gudang + "/show");
        }
        ...
        $("#tgl_mutasi_gudang").change(function() {
            ...
            $.ajax({
                type: 'POST'
                , url: '/repackrejectgj/buatnomorrepackreject'
                , data: {
                    _token: "{{csrf_token()}}"
