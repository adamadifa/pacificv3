                        ...
                        <form action="/penilaiankaryawan/store" method="POST">
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <td>{{ date('d-m-Y', strtotime($dari)) }} s/d {{ date('d-m-Y', strtotime($sampai)) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>NIK</td>
                                ...
                                <tr>
                                    <td>Departemen</td>
                                    <td>{{ $karyawan->kode_dept }} - {{ $karyawan->nama_dept }} /
                                        {{ $karyawan->nama_jabatan }}</td>
                                </tr>
                            </table>
                            ...
                            <br>
                            <br>
                            <small>Checklist bobot penilaian dibawah ini (semakin besar angka yang dipilih semakin baik
                                penilaian karyawan tersebut)</small>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($kategori_penilaian as $d)
                                        @if ($id_jenis_penilaian != $d->id_jenis_penilaian)
                                            ...
                                            <tr>
                                                <th colspan="3"
                                                    style="text-align: center; background-color:rgba(0, 255, 72, 0.235)">
                                                    {{ $d->jenis_penilaian }}</th>
                                            </tr>
                                            <tr>
                                                <th>No.</th>
                                                <th>Sasaran Kerja</th>
                                        ...
                                        @if (!empty($d->id_jenis_kompetensi) && $id_jenis_kompetensi != $d->id_jenis_kompetensi)
                                            <tr>
                                                <td colspan="3" style="text-align: center">
                                                    {{ $d->id_jenis_kompetensi == 1 ? 'Kompentensi Wajib' : 'Kompetensi' }}
                                                </td>
                                            </tr>
                                        @endif
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group" style="margin-bottom: 0 !important">
                                                    <select name="skor[]" required id="skor"
                                        ...
                                        <li class="d-inline-block mr-2">
                                            <fieldset>
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    <input type="checkbox" name="masa_kontrak_kerja" class="chb"
                                                        value="Tidak Diperpanjang">
