                ...
                <div class="col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="#" class="btn btn-primary" id="buatpenilaian"><i class="fa fa-plus mr-1"></i>
                                Buat Penilaian</a>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-12">
                                        <select name="filter" id="filter" class="form-control">
                                            ...
                                            <option value="1" {{ Request('filter') == 1 ? 'selected' : '' }}>Yang harus
                                                Di Setujui</option>
                                            <option value="2" {{ Request('filter') == 2 ? 'selected' : '' }}>Yang
                                                Sudah
                                                Di Setujui</option>
                                            <option value="3" {{ Request('filter') == 3 ? 'selected' : '' }}>Waiting
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4 col-sm-12">
                                                        ...
                                                        @if (array_search(strtolower($kat_jab_user), $approve) == 0 ||
                                                            ...
                                                            @if (empty($d->$field_kategori))
                                                                <a href="/penilaiankaryawan/{{ Crypt::encrypt($d->kode_penilaian) }}/edit"
                                                                    class="success"><i class="feather icon-edit"></i></a>
                                                            @endif
                                                        @endif
                                    ...
                                    <select name="nik" id="nik" class="form-control select2">
                                        ...
                                        @foreach ($karyawan as $d)
                                            <option value="{{ $d->nik }}">{{ $d->nik }}
                                                {{ $d->nama_karyawan }} ({{ $d->nama_jabatan }})</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
