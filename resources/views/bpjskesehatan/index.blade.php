...
@section('content')
                        ...
                        <div class="card">
                            @if (in_array($level, $insentif_tambah))
                                <div class="card-header">
                                    <a href="#" id="tambahbpjstk" class="btn btn-primary"><i
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            @if (in_array($level, $insentif_edit))
                                                                <a class="ml-1 edit"
                                                                    kode_bpjs_kes="{{ Crypt::encrypt($d->kode_bpjs_kes) }}"
                                                                    href="#"><i
                                                                        class="feather icon-edit success"></i></a>
                                                            @endif
                                                            @if (in_array($level, $insentif_hapus))
                                                                <form method="POST" class="deleteform"
                                                                    action="/bpjskesehatan/{{ Crypt::encrypt($d->kode_bpjs_kes) }}/delete">
                                                                    @csrf
                                                                    @method('DELETE')
    ...
    <!-- Input Gaji -->
    <div class="modal fade text-left" id="mdlinputbpjstk" tabindex="-1" role="dialog"
    ...
    <div class="modal fade text-left" id="mdleditbpjstk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
