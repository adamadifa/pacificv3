    ...
    <div class="row mb-3">
        <div class="col-12 px-0">
            ...
            <div class="swiper-container connectionwiper swiper-container-initialized swiper-container-horizontal">
                <div class="swiper-wrapper" id="swiper-wrapper-8e11048de6e4c4984" aria-live="polite"
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col">
                                                        <p class="small text-muted mb-0"
                                                            style="text-align: left !important">{{ $d->nama_cabang }}</p>
                                                        <p style="text-align: left !important">
                                                            {{ rupiah($d->totalpenjualan) }}</p>
                                                    </div>
        ...
        <div class="col-6 col-md-6">
            <a href="/sap/smactivity" class="card text-center">
                <div class="card-body">
                    ...
                    <p class="text-color-theme size-12 small" style="margin-top: 10px">Activity</p>
                </div>
            </a>
        </div>
    </div>
