...
@section('content')
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <a href="#" id="inputmutasibank" class="btn btn-primary"><i class="fa fa-plus mr-1"></i>
                            Tambah Data</a>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach ($mutasibank as $d)
                                    ...
                                    <tr>
                                        ...
                                        <td class="success text-right">
                                            {{ !empty($penerimaan) ? rupiah($penerimaan) : '' }}</td>
                                        <td class="danger text-right">
                                            {{ !empty($pengeluaran) ? rupiah($pengeluaran) : '' }}</td>
                                        <td class="text-right">{{ rupiah($saldo) }}</td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="ml-1 editmutasibank" href="#"
                                                    no_bukti="{{ $d->no_bukti }}"><i
                                                        class="feather icon-edit success"></i></a>
                                                <form method="POST" class="deleteform"
                                                    action="/mutasibank/{{ Crypt::encrypt($d->no_bukti) }}/delete">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <!-- Input Mutasi Bank -->
    <div class="modal fade text-left" id="mdlinputmutasibank" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
    ...
    <!-- Edit Mutasi Bank -->
    <div class="modal fade text-left" id="mdleditmutasibank" tabindex="-1" role="dialog"
        ...
        $(function() {
            ...
            $("#inputmutasibank").click(function(e) {
                ...
                if (kode_cabang == "") {
                    ...
                    $("#loadinputmutasibank").load('/mutasibank/' + kode_bank + '/' + kode_cabang +
                        '/create');
