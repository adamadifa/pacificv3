...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        @if (in_array($level, $permintaanpengiriman_tambah))
                            <a href="#" class="btn btn-primary" id="inputpermintaan"><i class="fa fa-plus mr-1"></i>
                                Tambah Data</a>
                        @endif
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-12">
                                    <x-inputtext field="tanggal" value="{{ Request('tanggal') }}"
                                        label="Tanggal Permintaan Pengiriman" icon="feather icon-calendar" datepicker />
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <select name="cabang" id="cabang" class="form-control">
                                            ...
                                            @foreach ($cabang as $d)
                                                <option {{ Request('cabang') == $d->kode_cabang ? 'selected' : '' }}
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option {{ Request('status') === '0' ? 'selected' : '' }} value="0">Belum
                                                Di
                                                Proses</option>
                                ...
                                <tbody>
                                    @foreach ($pp as $d)
                                        <tr>
                                            ...
                                            <td><a class="ml-1 detail" href="#"
                                                    no_permintaan_pengiriman="{{ Crypt::encrypt($d->no_permintaan_pengiriman) }}">{{ $d->no_permintaan_pengiriman }}</a>
                                            </td>

                                            <td>
                                                <a href="#"
                                                    no_permintaan_pengiriman="{{ $d->no_permintaan_pengiriman }}"
                                                    class="ubahtanggal">
                                            ...
                                            <td>{{ $d->no_dok }}</td>
                                            <td>{{ !empty($d->tgl_mutasi_gudang) ? date('d-m-Y', strtotime($d->tgl_mutasi_gudang)) : '' }}
                                            </td>
                                            <td>
                                                @if ($d->status == 1)
                                                    @if ($d->status_sj == 0)
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    @if (in_array($level, $permintaanpengiriman_hapus))
                                                        @if ($d->status == 0)
                                                            <form method="POST" class="deleteform"
                                                                action="/permintaanpengiriman/{{ Crypt::encrypt($d->no_permintaan_pengiriman) }}/delete">
                                                                @csrf
                                                                @method('DELETE')
                                                    ...
                                                    @if (in_array($level, $permintaanpengiriman_proses))
                                                        @if ($d->status == 0)
                                                            <a href="#" class="input_sj ml-1"
                                                                no_permintaan_pengiriman="{{ Crypt::encrypt($d->no_permintaan_pengiriman) }}"><i
                                                                    class="feather icon-external-link success"></i></a>
                                                        @else
                                                            @if ($d->status == 1 and $d->status_sj == 0)
                                                                <a href="/suratjalan/{{ Crypt::encrypt($d->no_mutasi_gudang) }}/batalkansuratjalan"
    ...
    <div class="modal fade text-left" id="mdldetailpp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
    ...
    <div class="modal fade text-left" id="mdlubahtanggal" tabindex="-1" role="dialog"
    ...
    <div class="modal fade text-left" id="mdlinputpengiriman" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel18" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/permintaanpengiriman/store" id="frmPermintaanpengiriman" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <x-inputtext field="no_permintaan_pengiriman" label="Auto" readonly
                                    icon="feather icon-credit-card" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <x-inputtext field="tgl_permintaan_pengiriman" label="Tanggal Permintaan Pengiriman"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <div class="form-group">
                                    <a href="#" class="btn btn-primary" id="tambahproduk"><i
    ...
    <!-- Input Surat Jalan -->
    <div class="modal fade text-left" id="mdlinputsj" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
