    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Saldo Awal Gudang Logistik</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/saldoawalgudanglogistik">Saldo Awal Gudang Logistik</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-6">
            <div class="card">
                <div class="card-header">
                    <a href="/saldoawalgudanglogistik/create" class="btn btn-primary"><i class="fa fa-plus mr-1"></i> Tambah Data</a>
                </div>
                <div class="card-body">
                    <form action="/saldoawalgudanglogistik">
                        <div class="row">
                            <div class="col-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a class="ml-1 detail" href="/saldoawalgudanglogistik/{{ Crypt::encrypt($d->kode_saldoawal_gl) }}/edit"><i class=" feather icon-edit success"></i></a>
                                            <form method="POST" class="deleteform" action="/saldoawalgudanglogistik/{{Crypt::encrypt($d->kode_saldoawal_gl)}}/delete">
                                                @csrf
                                                @method('DELETE')
