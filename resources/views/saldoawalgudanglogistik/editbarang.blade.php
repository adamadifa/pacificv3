<form action="/saldoawalgudanglogistik/{{ Crypt::encrypt($detail->kode_saldoawal_gl) }}/{{ Crypt::encrypt($detail->kode_barang) }}/updatebarang" method="POST">
    @csrf
    <div class="row">
        <div class="col-12">
            <table class="table">
            ...
            <div class="row">
                <div class="col-12">
                    <x-inputtext label="Harga" field="harga" icon="feather icon-file" value="{{ desimal($detail->harga) }}" right />
                </div>
            </div>
