...
<div class="row mb-2 mt-1">
    <div class="col-12 d-flex justify-content-between">
        <a href="#" class="btn btn-success" id="tambahkansemua" kode_dept="{{ $kode_dept }}" kode_lembur="{{ $kode_lembur }}" id_kantor="{{ $id_kantor }}"><i class="feather icon-user-check mr-1"></i>Tambahkan Semua</a>
        <a href="#" class="btn btn-danger" id="batalkansemua" kode_dept="{{ $kode_dept }}" kode_lembur="{{ $kode_lembur }}" id_kantor="{{ $id_kantor }}"><i class="feather icon-user-x mr-1"></i>Batalkan Semua</a>
    </div>
</div>
<div class="row">
    <div class="col-12">
