                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-header">
                            <a href="#" class="btn btn-primary" id="tambahkaryawan"><i class="fa fa-plus mr-1"></i>
                                Tambah Karyawan</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>Tanggal</th>
                                            <td>{{ date('d-m-Y H:i', strtotime($lembur->tanggal_dari)) }} s.d
                                                {{ date('d-m-Y H:i', strtotime($lembur->tanggal_sampai)) }}</td>
                                        </tr>
                                        <tr>
                                            <th>Istirahat</th>
                                            <td>
    ...
    <script>
        $(function() {
            $("#tambahkaryawan").click(function(e) {
                ...
                $("#loadkaryawan").load('/lembur/' + kode_lembur + '/' + id_kantor + '/' + kode_dept +
                    '/getkaryawan');
            });
