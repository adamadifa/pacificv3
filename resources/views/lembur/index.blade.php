                                    ...
                                    <form action="{{ URL::current() }}">
                                        @if (in_array($level, ['admin', 'manager hrd', 'spv presensi', 'direktur']))
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2">
                                                    <div class="form-group">
                                                        <select name="kategori_search" id="kategori_search" class="form-control">
                                                            ...
                                                            <option value="1" {{ Request('kategori_search') == 1 ? 'selected' : '' }}>
                                                                REGULER</option>
                                                            <option value="2" {{ Request('kategori_search') == 2 ? 'selected' : '' }}>
                                                ...
                                                <div class="col-2">
                                                    <div class="form-group">
                                                        <select name="kode_cabang_search" id="kode_cabang_search" class="form-control">
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        <select name="kategori_search" id="kategori_search" class="form-control">
                                                            ...
                                                            <option value="3" {{ Request('kategori_search') == 3 ? 'selected' : '' }}>WFH
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            @foreach ($lembur as $d)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            @php
                                                                $level_head = ['spv maintenance', 'manager produksi', 'manager ga', 'kepala gudang'];
                                                            @endphp
                                                            @if (in_array($level, $level_head))
                                                                @if (empty($d->head))
                                                                    <a href="#" kode_lembur="{{ Crypt::encrypt($d->kode_lembur) }}"
                                                                        class="approve"><i class="feather icon-external-link primary"></i></a>
                                                            ...
                                                            @if ($level == 'manager hrd' || $level == 'admin' || $level == 'spv presensi')
                                                                <a href="#" class="ket_hrd" kode_lembur="{{ $d->kode_lembur }}"><i
