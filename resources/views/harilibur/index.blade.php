                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="#" class="btn btn-primary" id="tambahlibur"><i class="fa fa-plus mr-1"></i>
                                Tambah Data</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            @if ($level == 'manager hrd')
                                                                ...
                                                                @else
                                                                    <a href="/harilibur/{{ Crypt::encrypt($d->kode_libur) }}/batalkan"
                                                                        class="warning">Batalkan</a>
                                                                @endif
                                                            @endif
                                                            <a
                                                                href="/harilibur/{{ Crypt::encrypt($d->kode_libur) }}/tambahkaryawan">
                                                                <i class="feather icon-settings success ml-1"></i>
                                                            </a>

                                                            @if (empty($d->hrd))
                                                                <form method="POST" class="deleteform"
                                                                    action="/harilibur/{{ Crypt::encrypt($d->kode_libur) }}/delete">
                                                                    @csrf
                                                                    @method('DELETE')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/harilibur/store" method="POST" id="frmLibur">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <x-inputtext label="Auto" field="kode_libur" icon="feather icon-credit-card"
                                    readonly />
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row" id="tgldiganti">
                            <div class="col-12">
                                <x-inputtext label="Tanggal Libur Yang Diganti" field="tanggal_diganti"
