            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/pengeluaranmaintenance">Data Barang Keluar</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-md-8 col-sm-8">
            <div class="card">
                <div class="card-header">
                    <a href="/pengeluaranmaintenance/create" class="btn btn-primary"><i class="fa fa-plus mr-1"></i> Tambah Data</a>
                </div>
                <div class="card-body">
                    <form action="/pengeluaranmaintenance">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover-animation">
                            ...
                            <tbody>
                                @foreach ($pengeluaranmtc as $d)
                                <tr>
                                    <td class="text-center">{{ $loop->iteration + $pengeluaranmtc->firstItem() - 1 }}</td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <form method="POST" class="deleteform" action="/pengeluaranmaintenance/{{Crypt::encrypt($d->nobukti_pengeluaran)}}/delete">
                                                @csrf
                                                @method('DELETE')
                        ...
                        {{ $pengeluaranmtc->links('vendor.pagination.vuexy') }}
                    </div>
...
<script>
    $(function() {
        function loaddetail(nobukti_pengeluaran) {
            $.ajax({
                type: 'POST'
                , url: '/pengeluaranmaintenance/show'
                , data: {
                    _token: "{{ csrf_token() }}"
