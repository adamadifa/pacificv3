...
@section('titlepage', 'Laporan Mutasi Produksi')
@section('content')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Laporan Mutasi Produksi</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/laporanproduksi/mtuasiproduksi">Laporan Mutasi
                                        Produksi</a>
                                </li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-9 col-sm-12">
                    <div class="row">
                        <div class="col-lg-7 col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="/laporanproduksi/mutasiproduksi/cetak" method="POST"
                                        id="frmMutasiproduksi" target="_blank">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12 col-sm-12">
                                                <div class="form-group">
                                                    <select name="kode_produk" id="kode_produk"
                                                        ...
                                                        @foreach ($barang as $d)
                                                            <option value="{{ $d->kode_produk }}">{{ $d->nama_barang }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
