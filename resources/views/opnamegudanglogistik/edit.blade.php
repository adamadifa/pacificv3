...
@section('titlepage','Edit Opname Gudang Logisitk')
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Edit Opname Gudang Logisitk</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Edit Opname Gudang Logisitk</a>
                            </li>
                        </ol>
                    </div>
                </div>
...
<script>
    $(function() {
        $(".edit").click(function(e) {
            ...
            var kode_opname = "{{ $opname->kode_opname_gl }}";
            $("#loadedit").load("/opnamegudanglogistik/" + kode_opname + "/" + kode_barang + "/editbarang");
            $('#mdledit').modal({
                backdrop: 'static'
                , keyboard: false
            });
