<form action="/worksheetom/storeprogram" method="POST" id="frmCreateprogram">
    @csrf
    <div class="row">
        <div class="col-12">
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                <x-inputtext label="Nama Program" field="nama_program" icon="feather icon-file" />
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-12">
            <div class="form-group">
                <select name="kode_reward" id="kode_reward" class="form-control">
                    ...
                    @foreach ($reward as $d)
                        <option value="{{ $d->kode_reward }}">{{ $d->nama_reward }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        @foreach ($produk as $d)
            <div class="col-4">
                <div class="vs-checkbox-con vs-checkbox-primary">
                    <input type="checkbox" name="kode_produk[]" value="{{ $d->kode_produk }}">
    ...
    <div class="row">
        <div class="col-12">
            <x-inputtext label="Jumlah Target" field="jml_target" icon="feather icon-file" right />
        </div>
    </div>
    <div class="row">
        <div class="col-12">
