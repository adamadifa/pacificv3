...
@section('titlepage','Data Ajuan Routing')
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Data Ajuan Routing</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/limitkredit">Data Ajuan Routing</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a class="ml-1"
                                                href="/ajuanrouting/{{ Crypt::encrypt($d->no_pengajuan) }}/approve"><i
                                                    class=" fa fa-check success"></i></a>
                                            <a class="ml-1"
                                                href="/ajuanrouting/{{ Crypt::encrypt($d->no_pengajuan) }}/decline"><i
