            ...
            @foreach ($piutangkaryawan as $d)
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        {{ !empty($piutang_jumlah_pembayaranpotongkomisi) ? rupiah($piutang_jumlah_pembayaranpotongkomisi) : '' }}</td>
                    <td style="text-align: right">{{ !empty($piutang_jumlah_pembayarantitipan) ? rupiah($piutang_jumlah_pembayarantitipan) : '' }}
                    </td>
                    <td style="text-align: right">{{ !empty($piutang_jumlah_pembayaranlainnya) ? rupiah($piutang_jumlah_pembayaranlainnya) : '' }}
                    </td>
