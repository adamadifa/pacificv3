...
@section('content')
                            ...
                            <tbody>
                                @foreach ($pinjaman as $d)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="ml-1 show" no_pinjaman_nonpjp="{{ $d->no_pinjaman_nonpjp }}"
                                                    href="#"><i class="feather icon-file-text info"></i></a>
                                                @if (empty($d->totalpembayaran) && Auth::user()->id == $d->id_user)
                                                    <form method="POST" class="deleteform"
                                                        action="/piutangkaryawan/{{ Crypt::encrypt($d->no_pinjaman_nonpjp) }}/delete">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <div class="modal fade text-left" id="mdlshowpinjaman" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
