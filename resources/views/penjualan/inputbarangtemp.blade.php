        ...
        <div class="col-12">
            <div class="form-group">
                <select name="kode_barang" id="kode_barang_pilih" class="form-control">
                    ...
                    @foreach ($barang as $d)
                    <option value="{{ $d->kode_barang }}" kode_barang="{{ $d->kode_barang }}" nama_barang="{{ $d->nama_barang }}" isipcsdus="{{ $d->isipcsdus }}" isipcs="{{ $d->isipcs }}" harga_dus="{{ rupiah($d->harga_dus) }}" harga_pack="{{ rupiah($d->harga_pack) }}" harga_pcs="{{ rupiah($d->harga_pcs) }}">{{ $d->nama_barang }} ({{ $d->kategori_harga }})</option>
                    @endforeach
                </select>
            </div>
        </div>
