      ...
      <tbody>
         ...
         @foreach ($persentaselokasi as $key => $d)
            ...
            <tr>
               ...
               <td align="center">{{ $d->signature_pemilik }}</td>
               <td align="center">{{ desimal($persentasesignaturepemilik) }} %</td>
               <td align="center">{{ $d->signature_karyawan }}</td>
               <td align="center">{{ desimal($persentasesignaturekaryawan) }} %</td>
