...
<head>
    ...
    <title>Cetak Laporan Penjualan PO</title>
    <style>
        body {
            font-family: 'Poppins'
        }
    ...
    <table class="datatable3" style="width:200%" border="1">
        <thead bgcolor="#024a75" style="color:white; font-size:12;">
            <tr bgcolor="#024a75" style="color:white; font-size:12;">
                ...
                <th rowspan="2" style="width: 3%;">Tgl PO</th>
                <th rowspan="2" style="width: 3%;">Tgl Kirim</th>
                ...
                <th rowspan="2" style="width: 3%; background-color: #024a75;">Dibuat</th>
                <th rowspan="2" style="width: 3%; background-color: #024a75;">Penginput</th>
        ...
        <tbody>
            ...
            @foreach ($penjualan as $d)
                @php
                    ...
                    $color = '';
                    $tgl_kirim = date('d-m-y', strtotime($d->date_created));
                    $ket = 'Sudah Di Proses';
                ...
                <tr style="font-size: 12px; background-color: {{ $color }}">
                    ...
                    <td align="center">{{ date('d-m-y', strtotime($d->date_created)) }}</td>
                    <td align="center">{{ $tgl_kirim }}</td>
                    ...
                    @endphp</b></td>
                    <td align="center">{{ date('d-m-y H:i:s', strtotime($d->date_created)) }}</td>
