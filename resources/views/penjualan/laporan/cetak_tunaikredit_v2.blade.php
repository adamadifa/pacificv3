    ...
    <table class="datatable3">
        <thead bgcolor="#295ea9" style="color:white;">
            <tr bgcolor="#295ea9" style="color:white;">
                ...
                <td rowspan="3" align="center">PPN/Ball/Dus</td>
        ...
        <tbody>
            ...
            $totalbrutotunai = $tunaikredit->sum('totaljual_tunai');
            ...
            <tr>
                ...
                <td style="text-align: right">
                    {{ !empty($ppnperproduk) ? rupiah($ppnperproduk) : '' }}
                </td>
                <td style="text-align: right">
                    {{ !empty($brutoppn) ? rupiah($brutoppn) : '' }}
                </td>
                <td style="text-align: right">
                    {{ !empty($ppnperdus) ? rupiah($ppnperdus) : '' }}
                </td>
            </tr>
            @endforeach
            @php
            ...
            <tr bgcolor="#06b947" style="color:white; font-size:12;">
                ...
                <td align="right"><?php echo rupiah($totalppnperproduk);  ?></td>
