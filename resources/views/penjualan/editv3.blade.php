                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="hidden" name="no_fak_penj" value="{{ $faktur->no_fak_penj }}"
                                                    id="no_fak_penj">
                                                <x-inputtext label="No. Faktur" value="{{ $faktur->no_fak_penj }}"
                                                    field="no_fak_penj_new" icon="fa fa-barcode" readonly />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Tanggal Transaksi" value="{{ $faktur->tgltransaksi }}"
                                                    field="tgltransaksi" icon="feather icon-calendar" readonly />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
