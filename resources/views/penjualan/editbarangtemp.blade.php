...
@php
$isipcsdus = $barangtemp->isipcsdus;
$isipack = $barangtemp->isipack;
$isipcs = $barangtemp->isipcs;
$jumlah = $barangtemp->jumlah;
...
<form action="#" id="frmeditbarangtemp">
    <input type="hidden" id="harga_dus_old" value="{{ rupiah($barangtemp->promo == 1 ? $barangtemp->harga_dus_old : $barangtemp->harga_dus) }}">
    <input type="hidden" id="harga_pack_old" value="{{ rupiah($barangtemp->promo == 1 ? $barangtemp->harga_pack_old :  $barangtemp->harga_pack) }}">
    <input type="hidden" id="harga_pcs_old" value="{{ rupiah( $barangtemp->promo == 1 ? $barangtemp->harga_pcs_old : $barangtemp->harga_pcs) }}">
    <div class="row">
        <div class="col-12">
            <x-inputtext label="Kode Barang" field="kode_barang" value="{{ $barangtemp->kode_barang }}" icon="feather icon-credit-card" readonly />
    ...
    <div class="row">
        <div class="col-12">
            <x-inputtext label="Nama Barang" field="nama_barang" value="{{ $barangtemp->nama_barang }}" icon="feather icon-file" readonly />
        </div>
    </div>
    <div class="row">
        <div class="col-4">
        ...
        <div class="col-8">
            <x-inputtext label="Dus" field="harga_dus" value="{{ rupiah($barangtemp->harga_dus) }}" icon="feather icon-tag" right />
        </div>
    </div>
    @if ($barangtemp->harga_pack != 0)
    <div class="row">
        <div class="col-4">
            <x-inputtext label="Pack" field="jml_pack" value="{{ rupiah($jumlah_pack) }}" icon="feather icon-file" right />
        </div>
        <div class="col-8">
            <x-inputtext label="Harga / Pack" field="harga_pack" value="{{ rupiah($barangtemp->harga_pack) }}" icon="feather icon-tag" right />
        </div>
    </div>
    @else
    <div class="row">
        ...
        <div class="col-8">
            <x-inputtext label="Harga / Pack" field="harga_pack" value="{{ rupiah($barangtemp->harga_pack) }}" icon="feather icon-tag" right readonly />
        </div>
    </div>
    @endif
    ...
    <div class="row">
        ...
        <div class="col-8">
            <x-inputtext label="Harga / Pcs" field="harga_pcs" value="{{ rupiah($barangtemp->harga_pcs) }}" icon="feather icon-tag" right />
        </div>
    </div>
    <div class="row mb-1">
        <div class="col-12">
            <div class="vs-checkbox-con vs-checkbox-primary">
                <input type="checkbox" class="promo" {{ $barangtemp->promo == 1 ? 'checked' : '' }} id="promo" name="promo" value="1">
    ...
    $(function() {
        ...
        $("#updatebarangtemp").click(function(e) {
            ...
            if (jumlah == "") {
                ...
                $.ajax({
                    type: 'POST'
                    , url: '/penjualan/updatebarangtemp'
                    , data: {
                        _token: "{{ csrf_token() }}"
