                                                ...
                                                @foreach ($detailpenjualan as $d)
                                                    ...
                                                    <tr @if ($d->promo == 1) class="bg-warning" @endif>
                                                        ...
                                                        <td colspan="8" style="font-weight: bold">
                                                            {{ $d->kode_produk }} - {{ $d->nama_barang }}</td>
                                                    </tr>
                                                    @if (!empty($jmldus))
                                                        <tr @if ($d->promo == 1) class="bg-warning" @endif>
                                                            <td colspan="7">{{ $jmldus }} Dus x
                                                                {{ rupiah($d->harga_dus) }}</td>
                                                            <td style="font-weight: bold; text-align:right">
                                                                {{ rupiah($jmldus * $d->harga_dus) }}</td>
                                                        </tr>
                                                    @endif
                                                    @if (!empty($jmlpack))
                                                        <tr @if ($d->promo == 1) class="bg-warning" @endif>
                                                            <td colspan="7">{{ $jmlpack }} Pack x
                                                                {{ rupiah($d->harga_pack) }}</td>
                                                            <td style="font-weight: bold; text-align:right">
                                                                {{ rupiah($jmlpack * $d->harga_pack) }}</td>
                                                        </tr>
                                                    @endif

                                                    @if (!empty($jmlpcs))
                                                        <tr @if ($d->promo == 1) class="bg-warning" @endif>
                                                            <td colspan="7">{{ $jmlpcs }} Pcs x
                                                                {{ rupiah($d->harga_pcs) }}</td>
                                                            <td style="font-weight: bold; text-align:right">
                                                                {{ rupiah($jmlpcs * $d->harga_pcs) }}</td>
                                                        </tr>
                                                    @endif
                                                @endforeach
                                                            ...
                                                            <div class="dropdown-menu" x-placement="top-start"
                                                                ...
                                                                <form method="POST" class="deleteform"
                                                                    ...
                                                                    <a href="#" tanggal="{{ $d->tglbayar }}"
                                                                        class=" dropdown-item delete-confirm ml-1">
                                                                ...
                                                                <div class="dropdown-menu" x-placement="top-start"
                                                                    ...
                                                                    <form method="POST" class="deleteform"
                                                                        ...
                                                                        <a href=" #" tanggal="{{ $d->tgl_giro }}"
                                                                            class="delete-confirm dropdown-item ml-1">
                                                                            <i class="feather icon-trash danger mr-1"></i>
                                                                            Hapus
                                                                        </a>
                                                                    </form>
                                        ...
                                        @else
                                            <select name="id_karyawan" id="id_karyawan" class="form-control">
                                                ...
                                                @foreach ($salesman as $d)
                                                    <option value="{{ $d->id_karyawan }}">{{ $d->nama_karyawan }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        @endif
