                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row" id="ceknofak">
                                            ...
                                            <div class="col">
                                                <div class="alert alert-danger">
                                                    <h4 class="alert-heading"><i class="feather icon-info mr-1"></i> Warning
                                                        !</h4>
                                                    <p>No. Faktur Sudah Digunakan, Silahkan Hubungi Admin Untuk mengetahun
                                                        No. Faktur Terakhir</p>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="No. Faktur" field="no_fak_penj" value="{{ $no_fak_penj_auto }}"
                                                    icon="fa fa-barcode" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Tanggal Transaksi" field="tgltransaksi" icon="feather icon-calendar"
                                                    value="{{ date('Y-m-d') }}" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="hidden" name="kode_pelanggan" id="kode_pelanggan"
                                                    value="{{ $pelanggan != null ? $pelanggan->kode_pelanggan : '' }}">
                                                <input type="hidden" id="kode_cabang" class="form-control" name="kode_cabang"
                                                    value="{{ $pelanggan != null ? $pelanggan->kode_cabang : '' }}">
                                                <input type="hidden" id="jatuhtempo" class="form-control" name="jatuhtempo"
                                                    value="{{ $pelanggan != null ? $pelanggan->jatuhtempo : '' }}">
                                                <input type="hidden" id="limitpel" class="form-control" name="limitpel"
                                                    value="{{ $pelanggan != null && !empty($pelanggan->limitpel) ? $pelanggan->limitpel : 0 }}">
                                                <x-inputtext label="Pelanggan" field="nama_pelanggan" icon="feather icon-user"
                                                    value="{{ $pelanggan != null ? $pelanggan->kode_pelanggan . '|' . $pelanggan->nama_pelanggan : '' }}"
                                                    readonly />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="hidden" value="{{ $pelanggan != null ? $pelanggan->id_sales : '' }}" name="id_karyawan"
                                                    id="id_karyawan">
                                                <input type="hidden" value="{{ $pelanggan != null ? $pelanggan->kategori_salesman : '' }}"
                                                    name="kategori_salesman" id="kategori_salesman">
                                                <input type="hidden" value="{{ $pelanggan != null ? $pelanggan->status_promo : '' }}"
                                                    name="status_promo" id="status_promo">
                                                <x-inputtext label="Salesman" field="nama_karyawan" icon="feather icon-users"
                                                    value="{{ $pelanggan != null ? $pelanggan->id_sales . '|' . $pelanggan->nama_karyawan . '|' . $pelanggan->kategori_salesman : '' }}"
                                                    readonly />
                                            </div>
                                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-content">
                                        <img class="card-img-top img-fluid" id="foto" src="{{ asset('app-assets/images/slider/04.jpg') }}"
                                            alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title">
                                            ...
                                            <b>Alamat</b>
                                            <p class="card-text" id="alamat_text">
                                                {{ $pelanggan != null ? $pelanggan->alamat_pelanggan : '' }}</p>
                                            <b>No. HP</b>
                                            <p class="card-text" id="no_hp">
                                                {{ $pelanggan != null ? $pelanggan->no_hp : '' }}</p>
                                            <b>Koordinat</b>
                                            <p class="card-text" id="koordinat">
                                                {{ $pelanggan != null ? $pelanggan->latitude : '' }},{{ $pelanggan != null ? $pelanggan->longitude : '' }}
                                            </p>
                                            <b>Limit Pelanggan</b>
                                            <p class="card-text" id="limitpelanggan">
                                                {{ rupiah($pelanggan != null ? $pelanggan->limitpel : 0) }}</p>
                                            <b>Piutang Pelanggan</b>
                                            <p class="card-text" id="piutangpelanggan">
                                                {{ rupiah($piutang != null ? $piutang->sisapiutang : 0) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="form-group" style="margin-bottom:5px">
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" id="potaida" class="form-control text-right money"
                                                                    name="potaida" placeholder="Aida" readonly>
                                                                <div class="form-control-position">
                                                        ...
                                                        <div class="form-group" style="margin-bottom:5px">
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" id="potswan" class="form-control text-right money"
                                                                    name="potswan" placeholder="Swan" readonly>
                                                                <div class="form-control-position">
                                                        ...
                                                        <div class="form-group" style="margin-bottom:5px">
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" id="potstick" class="form-control text-right money"
                                                                    name="potstick" placeholder="Stick" readonly>
                                                                <div class="form-control-position">
                                                        ...
                                                        <div class="form-group" style="margin-bottom:5px">
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" id="potsp" class="form-control text-right money"
                                                                    name="potsp" placeholder="Premium" readonly>
                                                                <div class="form-control-position">
                                                        ...
                                                        <div class="form-group" style="margin-bottom:5px">
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" id="potsb" class="form-control text-right money"
                                                                    name="potsb" placeholder="Sambal" readonly>
                                                                <div class="form-control-position">
        ...
        $(function() {
            ...
            $("form").submit(function(e) {
                ...
                if (cektutuplaporan > 0) {
                    ...
                    return false;
                } else if (parseInt(sisafakturkredit) >= parseInt(jmlfaktur) && sikluspembayaran == 0 &&
