                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" id="kode_cabang" class="form-control" name="kode_cabang" value="{{ $pelanggan->kode_cabang }}">
                                            <input type="hidden" id="jatuhtempo" class="form-control" name="jatuhtempo" value="{{ $pelanggan->jatuhtempo }}">
                                            <input type="hidden" id="limitpel" class="form-control" name="limitpel" value="{{ $pelanggan->limitpel }}">
                                            <x-inputtext label="Pelanggan" field="nama_pelanggan" icon="feather icon-user" value="{{ $pelanggan->kode_pelanggan }} | {{ $pelanggan->nama_pelanggan }}" readonly />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <input type="hidden" value="{{ $pelanggan->id_sales }}" name="id_karyawan" id="id_karyawan">
                                            <input type="hidden" value="{{ $pelanggan->kategori_salesman }}" name="kategori_salesman" id="kategori_salesman">
                                            <x-inputtext label="Salesman" field="nama_karyawan" icon="feather icon-users" value="{{ $pelanggan->id_sales }} | {{ $pelanggan->nama_karyawan }} | {{ $pelanggan->kategori_salesman }}" readonly />
                                        </div>
                                    </div>
                                </div>
                            </div>
