...
@section('content')
        ...
        <div class="content-body">
            ...
            <form action="/penjualan/store" method="POST" id="frmPenjualan">
                ...
                <input type="hidden" id="sisapiutang" name="sisapiutang"
                    value="{{ $piutang != null ? $piutang->sisapiutang : 0 }}">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="No. Faktur" field="no_fak_penj"
                                                    value="{{ $no_fak_penj_auto }}" icon="fa fa-barcode" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Tanggal Transaksi" field="tgltransaksi"
                                                    icon="feather icon-calendar" value="{{ date('Y-m-d') }}" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="hidden"
                                                    value="{{ $pelanggan != null ? $pelanggan->id_sales : '' }}"
                                                    name="id_karyawan" id="id_karyawan">
                                                <input type="hidden"
                                                    value="{{ $pelanggan != null ? $pelanggan->kategori_salesman : '' }}"
                                                    name="kategori_salesman" id="kategori_salesman">
                                                <input type="hidden"
                                                    value="{{ $pelanggan != null ? $pelanggan->status_promo : '' }}"
                                    ...
                                    <div class="card-header d-flex align-items-start pb-0">
                                        <div class="avatar bg-rgba-info m-2" style="padding:3rem" id="bgiconcart">
                                            <div class="avatar-content">
                                                <i class="feather icon-shopping-cart text-info" id="iconchart"
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-hover-animation tabelpelanggan" style="width:100% !important"
                            id="tabelpelanggan" style="font-size: 11px !important">
    ...
    <div class="modal fade text-left" id="mdlinputbarang" tabindex="-1" role="dialog"
