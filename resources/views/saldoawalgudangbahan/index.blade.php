    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Saldo Awal Gudang Bahan</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/saldoawalgudangbahan">Saldo Awal Gudang Bahan</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-6">
            <div class="card">
                <div class="card-header">
                    <a href="/saldoawalgudangbahan/create" class="btn btn-primary"><i class="fa fa-plus mr-1"></i> Tambah Data</a>
                </div>
                <div class="card-body">
                    <form action="/saldoawalgudangbahan">
                        <div class="row">
                            <div class="col-3">
                        ...
                        <table class="table table-hover-animation">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $d->kode_saldoawal_gb }}</td>
                                    <td>{{ $bulan[$d->bulan] }}</td>
                                    <td>{{ $d->tahun }}</td>
                                    <td>{{ date("d-m-Y",strtotime($d->tanggal)) }}</td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a class="ml-1 detail" href="/saldoawalgudangbahan/{{ Crypt::encrypt($d->kode_saldoawal_gb) }}/edit"><i class=" feather icon-edit success"></i></a>
                                            <form method="POST" class="deleteform" action="/saldoawalgudangbahan/{{Crypt::encrypt($d->kode_saldoawal_gb)}}/delete">
                                                @csrf
                                                @method('DELETE')
