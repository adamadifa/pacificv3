...
<div class="content-wrapper">
    ...
    <div class="content-body">
        ...
        <div class="col-md-10 col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="/omancabang/{{ Crypt::encrypt($dataoman->no_order) }}/update">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4 col-sm-12">
                                <div class="form-group  ">
                                    <select name="kode_cabang" id="kode_cabang" class="form-control" disabled>
                                        ...
                                        @foreach ($cabang as $c)
                                        <option @if ($c->kode_cabang == $dataoman->kode_cabang)
                                            selected
                                            @endif value="{{ $c->kode_cabang }}">{{ strtoupper($c->nama_cabang) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
