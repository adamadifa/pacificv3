                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group  ">
                                        <select name="kode_cabang" id="kode_cabang" class="form-control">
                                            ...
                                            @foreach ($cabang as $c)
                                                <option value="{{ $c->kode_cabang }}">{{ strtoupper($c->nama_cabang) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <table class="table" id="mytable">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($produk as $d)
                                        <tr>
                                            <td>
                                                <input type="hidden" name="kode_produk{{ $loop->iteration }}"
                                                    value="{{ $d->kode_produk }}">
                                                {{ $loop->iteration }}
                                            </td>
                                            <td>{{ $d->kode_produk }}</td>
                                            <td>{{ $d->nama_barang }}</td>
                                            <td colspan="3">
                                                <input type="text" id="jmlm1" name="jml{{ $loop->iteration }}m1"
                                                    class="form-control jmlm1" style="text-align:right" />
                                            </td>
                                            <td colspan="3">
                                                <input type="text" id="jmlm2" name="jml{{ $loop->iteration }}m2"
                                                    class="form-control jmlm2" style="text-align:right" />
                                            </td>
                                            <td colspan="3">
                                                <input type="text" id="jmlm3" name="jml{{ $loop->iteration }}m3"
                                                    class="form-control jmlm3" style="text-align:right" />
                                            </td>
                                            <td colspan="3">
                                                <input type="text" id="jmlm4" name="jml{{ $loop->iteration }}m4"
                                                    class="form-control jmlm4" style="text-align:right" />
                                            </td>
                                            <td>
                                                <input type="text" id="subtotal"
                                                    name="subtotal{{ $loop->iteration }}" class="form-control subtotal"
