                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" id="bulan" name="bulan">
                                            ...
                                            ?>
                                            <option <?php if (empty(Request('bulan'))) {
                                                if ($bulanini == $i && Auth::user()->kode_cabang == 'PCF') {
                                                    echo 'selected';
                                                }
                                            } else {
                                                if (Request('bulan') == $i) {
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        ?>
                                            <option <?php if (empty(Request('tahun'))) {
                                                if (date('Y') == $thn) {
                                                    echo 'Selected';
                                                }
                                            } else {
                                                if (Request('tahun') == $thn) {
                                                    echo 'selected';
                                                }
                                            } ?> value="<?php echo $thn; ?>">
                                                <?php echo $thn; ?>
                                ...
                                <div class="col-lg-3 col-sm-12">
                                    <div class="btn-group">
                                        ...
                                        <button type="submit" name="cetak" formtarget="_blank" value="1"
                                            class="btn btn-success"><i class="feather icon-printer"></i></button>
                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    @endif
                                                    <a class="ml-1 detailomancabang" no_order="{{ $d->no_order }}"
                                                        href="#"><i class=" feather icon-file-text info"></i></a>

                                                    <a href="/omancabang/{{ Crypt::encrypt($d->no_order) }}/cetak"
                                                        target="_blank">
                                                        <i class="feather icon-printer info ml-1"></i>
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
