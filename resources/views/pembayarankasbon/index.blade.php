    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Pembayaran Kasbon</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/pembayarankasbon">Pembayaran Kasbon</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover-animation">
                            ...
                            <tbody>
                                @foreach ($kasbonpotongangaji as $d)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            @if ($loop->last)
                                            <form method="POST" class="deleteform" action="/pembayarankasbon/{{Crypt::encrypt($d->kode_potongan)}}/deletegenerate">
                                                @csrf
                                                @method('DELETE')
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/pembayarankasbon/generatebayarpinjaman" method="POST" id="frmGenerate">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
...
<div class="modal fade text-left" style="z-index: 1052 !important" id="mdldetailpembayaran" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel18">Data Pembayaran Kasbon</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
