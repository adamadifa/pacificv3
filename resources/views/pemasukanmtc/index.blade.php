            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/pemasukanmaintenance">Data Barang Masuk</a>
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="content-body">
        ...
        <div class="col-md-12 col-sm-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/pemasukanmaintenance">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover-animation">
                            ...
                            <tbody>
                                @foreach ($pemasukanmtc as $d)
                                <tr>
                                    <td class="text-center">{{ $loop->iteration + $pemasukanmtc->firstItem() - 1 }}</td>
                        ...
                        {{ $pemasukanmtc->links('vendor.pagination.vuexy') }}
                    </div>
