...
@foreach ($barang as $d)
    ...
    <tr>
        ...
        <td></td>
        <td>
            <input type="text" class="form-control text-center jmldus" id="jmldus" name="jmldus[]"
                value="{{ $jmldus }}">
        </td>
        <td>
            <input type="hidden" class="form-control text-right harga_dus_old" id="harga_dus_old"
                name="harga_dus_old[]" value="{{ rupiah($d->harga_dus) }}">
            <input type="text" class="form-control text-right harga_dus money" id="harga_dus" name="harga_dus[]"
                value="{{ rupiah($d->harga_dus) }}">
        </td>
        <td>

            <input type="{{ !empty($d->harga_pack) ? 'text' : 'hidden' }}" class="form-control text-center jmlpack"
                id="jmlpack" name="jmlpack[]" value="{{ $jmlpack }}">

        </td>
        <td>

            <input type="{{ !empty($d->harga_pack) ? 'hidden' : 'hidden' }}"
                class="form-control text-right harga_pack_old" id="harga_pack_old" name="harga_pack_old[]"
                value="{{ rupiah($d->harga_pack) }}">
            <input type="{{ !empty($d->harga_pack) ? 'text' : 'hidden' }}"
                class="form-control text-right harga_pack money" id="harga_pack" name="harga_pack[]"
                value="{{ rupiah($d->harga_pack) }}">

        </td>
        <td>

            <input type="text" class="form-control text-center jmlpcs" id="jmlpcs" name="jmlpcs[]"
                value="{{ $jmlpcs }}">
        </td>
        <td>
            <input type="hidden" class="form-control text-right harga_pcs_old " id="harga_pcs_old"
                name="harga_pcs_old[]" value="{{ rupiah($d->harga_pcs) }}">
            <input type="text" class="form-control text-right harga_pcs money " id="harga_pcs" name="harga_pcs[]"
                value="{{ rupiah($d->harga_pcs) }}">
        </td>
...
<script>
    $(function() {
        ...
        $tblrows.each(function(index) {
            var $tblrow = $(this);
            $tblrow.find('.jmldus,.jmlpack,.jmlpcs,.harga_dus,.harga_pack,.harga_pcs').on('keyup',
                function() {
                    //alert('test');
                    var kode_pelanggan = $("#kode_pelanggan").val();
                    ...
                    if (harga_pack === 0) {
                        ...
                        var total = (jmldus * harga_dus) + (jmlpack * harga_pack) + (jmlpcs *
                            harga_pcs);
                        $.ajax({
                            type: 'POST',
                            url: '/retur/updatedetailtemp',
