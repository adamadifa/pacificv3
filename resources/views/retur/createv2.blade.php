...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            <form name="autoSumForm" autocomplete="off" action="/retur/store" class="formValidate form-horizontal"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Tanggal Retur" value="{{ date('Y-m-d') }}"
                                                    field="tglretur" icon="feather icon-calendar" readonly datepicker />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <input type="hidden" id="limitpel" class="form-control" name="limitpel"
                                                    value="{{ $pelanggan != null ? $pelanggan->limitpel : '' }}">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <a href="#" id="addproduct" class="btn btn-info btn-block"><i
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group" style="margin-bottom: 5px">
                                                            <select class="form-control" name="jenis_retur"
                                                                id="jenis_retur">
                                                        ...
                                                        <div class="form-group" style="margin-bottom: 5px">
                                                            <select class="form-control select2" name="no_fak_penj"
                                                                id="no_fak_penj">
    ...
    @if ($level != 'salesman')
        <div class="modal fade text-left" id="mdlpelanggan" tabindex="-1" role="dialog"
