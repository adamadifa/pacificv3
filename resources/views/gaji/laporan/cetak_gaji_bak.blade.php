                ...
                <?php
                    ...
                    for ($i = 0; $i < count($rangetanggal); $i++) {
                        ...
                        if ($d->$hari_ke != null) {
                            ...
                            $izinabsen = 0;
                            $izinsakit = 0;
                            if ((!empty($ceklibur) && $cekmasakerja >= 3) || !empty($cekliburpenggantiminggu) || !empty($cekwfh) || (!empty($cekwfhfull) && $cekmasakerja >= 3)) {
                                $tidakhadir = 0;
                            } else {
                                if ($namahari == 'Sabtu') {
                                    $tidakhadir = 5;
