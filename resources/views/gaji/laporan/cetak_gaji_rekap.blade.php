                ...
                <tr>
                    ...
                    @php
                        ...
                        $total_t_tanggungjawab_rekap =
                            ...
                            $total_t_tanggungjawab_penjualan +
                        ...
                        $total_im_ruanglingkup_rekap =
                            ...
                            $total_im_ruanglingkup_penjualan +
                            $total_im_ruanglingkup_tkl +
                        ...
                        $total_upah_overtime_libur_rekap =
                        ...
                        $total_all_hari_shift_2_rekap =
                            ...
                            $total_all_hari_shift_2_penjualan +
                            $total_all_hari_shift_2_tkl +
                            $total_all_hari_shift_2_tktl;

                        $total_all_premi_shift_2_rekap =
                            $total_all_premi_shift_2_administrasi +
                            $total_all_premi_shift_2_penjualan +
                            $total_all_premi_shift_2_tkl +
                            $total_all_premi_shift_2_tktl;

                        $total_all_hari_shift_3_rekap =
                            $total_all_hari_shift_3_administrasi +
                            $total_all_hari_shift_3_penjualan +
                            $total_all_hari_shift_3_tkl +
                            $total_all_hari_shift_3_tktl;

                        $total_all_premi_shift_3_rekap =
                            $total_all_premi_shift_3_administrasi +
                            $total_all_premi_shift_3_penjualan +
                            $total_all_premi_shift_3_tkl +
                        ...
                        $total_all_potonganjam_rekap =
                            ...
                            $total_all_potonganjam_penjualan +
                            $total_all_potonganjam_tkl +
                            $total_all_potonganjam_tktl;

                        $total_all_bpjskesehatan_rekap =
                            $total_all_bpjskesehatan_administrasi +
                            $total_all_bpjskesehatan_penjualan +
                            $total_all_bpjskesehatan_tkl +
