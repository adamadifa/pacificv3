...
@section('content')
            ...
            <div class="col-md-6 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <a href="#" class="btn btn-primary" id="inputtutuplaporan"><i class="fa fa-plus mr-1"></i>
                            Tambah Data</a>
                    </div>
                                    ...
                                    @foreach ($tutuplap as $d)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($d->status == 1)
                                                    <a
                                                        href="/tutuplaporan/{{ Crypt::encrypt($d->kode_tutuplaporan) }}/bukalaporan"><i
                                                            class="feather icon-lock danger"></i></a>
                                                @else
                                                    <a
                                                        href="/tutuplaporan/{{ Crypt::encrypt($d->kode_tutuplaporan) }}/tutuplaporan"><i
                                                            class="feather icon-unlock success"></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
    ...
    <!-- Input LPC -->
    <div class="modal fade text-left" id="mdlinputtutuplaporan" tabindex="-1" role="dialog"
