                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge bg-success"><i
                                                        class="fa fa-check"></i>{{ date('d-m-Y', strtotime($d->tgl_setoranpusat)) }}</span>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                @if (empty($d->tgl_setoranpusat))
                                                    <a class="setorkan" href="#" kode_transfer="{{ $d->kode_transfer }}"><i
                                                            class=" feather icon-external-link success"></i></a>
                                                @else
                                                    <a href="/setorantransfer/{{ Crypt::encrypt($d->kode_transfer) }}/delete" class="danger"><i
                                                            class="fa fa-close"></i></a>
                                                @endif
                                                <a class="ml-1 detailfaktur" href="#" kode_transfer="{{ $d->kode_transfer }}"><i
