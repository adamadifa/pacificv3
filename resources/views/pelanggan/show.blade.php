                            ...
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">
                                            <span
                                                class="badge badge-pill bg-primary float-right">{{ $data->latitude }},{{ $data->longitude }}</span>
                                            Lokasi
                                        </li>
                                        {{-- <li class="list-group-item">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="penjualan-tab" data-toggle="tab" href="#penjualan"
                                            aria-controls="penjualan" role="tab" aria-selected="true">Transaksi
                                            Penjualan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="limitkredit-tab" data-toggle="tab" href="#limitkredit"
                                            aria-controls="limitkredit" role="tab" aria-selected="false">Pengajuan
                                            Limit Kredit</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="penjualan" aria-labelledby="penjualan-tab"
                                        ...
                                        <form action="">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <x-inputtext label="Dari" field="dari"
                                                        icon="feather icon-calendar" datepicker
                                                        value="{{ Request('dari') }}" />
                                                </div>
                                                <div class="col-lg-6">
                                                    <x-inputtext label="Sampai" field="sampai"
                                                        icon="feather icon-calendar" datepicker
                                                        ...
                                                        <tbody>
                                                            @foreach ($penjualan as $d)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $d->no_fak_penj }}</td>
                                                                    <td>{{ date('d-m-Y', strtotime($d->tgltransaksi)) }}
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group" role="group"
                                                                            ...
                                                                            <a class="ml-1"
                                                                                href="/penjualan/{{ \Crypt::encrypt($d->no_fak_penj) }}/edit"><i
                                                                            ...
                                                                            <div class="dropdown ml-1">
                                                                                <a class="dropdown-toggle mr-1"
                                                                                    ...
                                                                                    aria-expanded="false">
                                                                                    <i
                                                                                        class="feather icon-printer primary"></i>
                                                                                </a>
                                    ...
                                    <div class="tab-pane" id="limitkredit" aria-labelledby="limitkredit-tab"
                                        role="tabpanel">
                                            ...
                                            <tbody>
                                                @foreach ($limitkredit as $d)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#"><i
                                                                    class="feather icon-printer info"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
