                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Kode Pelanggan" field="kode_pelanggan"
                                                    icon="feather icon-credit-card" value="{{ $data->kode_pelanggan }}"
                                                    readonly />
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Nama Pelanggan" field="nama_pelanggan"
                                                    icon="feather icon-user" value="{{ $data->nama_pelanggan }}" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Tanggal Lahir" field="tgl_lahir"
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Alamat Pelanggan" field="alamat_pelanggan"
                                                    icon="feather icon-map" value="{{ $data->alamat_pelanggan }}" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    ...
                                                    <input type="checkbox" class="na_nohp"
                                                        @if ($data->no_hp == 'NA') checked @endif name="na_nohp"
                                                        value="1">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group @error('pasar') error @enderror">
                                                    <select name=" pasar" id="pasar" class="form-control select2">
                                                        ...
                                                        @foreach ($pasar as $d)
                                                            <option {{ $data->pasar == $d->nama_pasar ? 'selected' : '' }}
                                                                value="{{ $d->nama_pasar }}">{{ $d->nama_pasar }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('pasar')
                                                        ...
                                                        <ul class="list-unstyled mb-0">
                                                                ...
                                                                <fieldset>
                                                                    <div class="vs-checkbox-con vs-checkbox-success">
                                                                        <input type="checkbox" name="hari[]"
                                                                            <?php if (str_contains($data->hari, 'Senin')) {
                                                                                echo 'checked';
                                                                            }
                                                                            ?> value="Senin">
                                                                        <span class="vs-checkbox">
                                                            ...
                                                            <li class="d-inline-block mr-2">
                                                                <fieldset>
                                                                    <div class="vs-checkbox-con vs-checkbox-success">
                                                                        <input type="checkbox" name="hari[]"
                                                                            <?php if (str_contains($data->hari, 'Selasa')) {
                                                                                echo 'checked';
                                                                            }
                                                                            ?> value="Selasa">
                                                                        <span class="vs-checkbox">
                                                            ...
                                                            <li class="d-inline-block mr-2">
                                                                <fieldset>
                                                                    <div class="vs-checkbox-con vs-checkbox-success">
                                                                        <input type="checkbox" name="hari[]"
                                                                            value="Minggu" <?php if (str_contains($data->hari, 'Minggu')) {
                                                                                echo 'checked';
                                                                            }
                                                                            ?>>
                                                                        <span class="vs-checkbox">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-lg-6 col-sm-12">
                                                    <div class="form-group  @error('kode_cabang') error @enderror">
                                                        <select name="kode_cabang" id="kode_cabang" class="form-control">
                                                            ...
                                                            @foreach ($cabang as $c)
                                                                <option
                                                                    @isset($data->kode_cabang) @if (old('kode_cabang'))
                                                        {{ old('kode_cabang') == $c->kode_cabang ? 'selected' : '' }}
                                                        @else
                                                        {{ $data->kode_cabang == $c->kode_cabang ? 'selected' : '' }}
                                                        @endif @else
                                                        {{ old('kode_cabang') == $c->kode_cabang ? 'selected' : '' }}
                                                        @endisset
                                                                    value="{{ $c->kode_cabang }}">
                                            ...
                                            @else
                                                <input type="hidden" name="kode_cabang" id="kode_cabang"
                                                    value="{{ Auth::user()->kode_cabang }}" readonly>
                                            @endif
                                            <div class="col-lg-6 col-sm-12">
                                        ...
                                        @if (Auth::user()->kode_cabang == 'PCF')
                                            <div class="row">
                                                <div class="col-12">
                                                    <x-inputtext label="Limit Pelanggan" field="limitpel"
                                                        icon="feather icon-file" value="{{ rupiah($data->limitpel) }}"
                                                        right money />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group  @error('jatuhtempo') error @enderror">
                                                        <select name="jatuhtempo" id="" class="form-control">
                                                            ...
                                                            <option
                                                                @isset($data->jatuhtempo) @if (old('jatuhtempo'))
                                                        ...
                                                        @endisset
                                                                value="14">14</option>
                                                            <option
                                                                @isset($data->jatuhtempo) @if (old('hari'))
                                            ...
                                            <div class="col-12">
                                                <div class="form-group  @error('status_pelanggan') error @enderror">
                                                    <select name="status_pelanggan" id="" class="form-control">
                                                        ...
                                                        <option
                                                            @isset($data->status_pelanggan) @if (old('status_pelanggan'))
                                                        {{ old('status_pelanggan') == '1' ? 'selected' : '' }} @else
                                                        {{ $data->status_pelanggan == '1' ? 'selected' : '' }} @endif
                                                        @else
                                                        ...
                                                        {{ $data->status_pelanggan == '0' ? 'selected' : '' }} @endif
                                                        @else
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group  @error('kepemilikan') error @enderror">
                                                <select name="kepemilikan" id="" class="form-control">
                                                    ...
                                                    <option
                                                        @isset($data->kepemilikan) @if (old('kepemilikan'))
                                                    ...
                                                    {{ $data->kepemilikan == 'Milik Sendiri' ? 'selected' : '' }} @endif
                                                    @else
                                        ...
                                        <div class="col-12">
                                            <div class="form-group  @error('lama_usaha') error @enderror">
                                                <select name="lama_usaha" id="" class="form-control">
                                                    ...
                                                    <option
                                                        @isset($data->lama_usaha) @if (old('lama_usaha'))
                                                    {{ old('lama_usaha') == '< 2 Tahun' ? 'selected' : '' }} @else {{ $data->lama_usaha == '< 2 Tahun' ? 'selected' : '' }} @endif
                                                            @else {{ old('lama_usaha') == '< 2 Tahun' ? 'selected' : '' }}
                                                            @endisset
                                                        value="< 2 Tahun">
                                                        < 2 Tahun</option>
                                                    <option
                                                    ...
                                                    {{ $data->lama_usaha == '2-5 Tahun' ? 'selected' : '' }} @endif
                                                    @else
                                                    ...
                                                    {{ $data->lama_usaha == '> 5 Tahun' ? 'selected' : '' }} @endif
                                                    @else
                                        ...
                                        <div class="col-12">
                                            <div class="form-group  @error('status_outlet') error @enderror">
                                                <select name="status_outlet" id="" class="form-control">
                                                    ...
                                                    <option
                                                        @isset($data->status_outlet) @if (old('status_outlet'))
                                                    ...
                                                    @endisset
                                                        value="2">Existing Outlet</option>
                                                </select>
                                                @error('status_outlet')
                                                    <div class="help-block">
                                                        <ul role="alert">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group  @error('type_outlet') error @enderror">
                                                <select name="type_outlet" id="" class="form-control">
                                                    ...
                                                    <option
                                                        @isset($data->type_outlet) @if (old('type_outlet'))
                                                    ...
                                                    @endisset
                                                        @if (old('type_outlet') == '2') selected @endif value="2">
                                                        Retail</option>
                                                </select>
                                                @error('type_outlet')
                                                    <div class="help-block">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group  @error('cara_pembayaran') error @enderror">
                                                <select name="cara_pembayaran" id="" class="form-control">
                                                    ...
                                                    <option
                                                        @isset($data->cara_pembayaran) @if (old('cara_pembayaran'))
                                                    ...
                                                    @endisset
                                                        value="3">Cheque / Bilyet Giro</option>
                                                </select>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group  @error('lama_langganan') error @enderror">
                                                <select name="lama_langganan" id="" class="form-control">
                                                    ...
                                                    <option
                                                        @isset($data->lama_langganan) @if (old('lama_langganan'))
                                                    {{ old('lama_langganan') == '< 2 Tahun' ? 'selected' : '' }} @else
                                                        {{ $data->lama_langganan == '< 2 Tahun' ? 'selected' : '' }}
                                                            @endif @else {{ old('lama_langganan') == '< 2 Tahun' ? 'selected' : '' }} @endisset
                                                        value="< 2 Tahun">
                                                        < 2 Tahun</option>
                                                    <option
                                                        @isset($data->lama_langganan) @if (old('lama_langganan'))
                                                    {{ old('lama_langganan') == '> 2 Tahun' ? 'selected' : '' }} @else
                                                    {{ $data->lama_langganan == '> 2 Tahun' ? 'selected' : '' }} @endif
                                                    @else
                                        ...
                                        <div class="col-12">
                                            <div class="form-group  @error('jaminan') error @enderror">
                                                <select name="jaminan" id="" class="form-control">
                                                    ...
                                                    <option
                                                        @isset($data->jaminan) @if (old('jaminan'))
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <x-inputtext label="Omset Toko" field="omset_toko" icon="feather icon-file"
                                                right value="{{ rupiah($data->omset_toko) }}" money />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary mr-1 mb-1"><i
                                                    class="fa fa-refresh mr-1"></i> Update</button>
                                            <a href="{{ url()->previous() }}"
                                                class="btn btn-outline-warning mr-1 mb-1"><i
                                                    class="fa fa-arrow-left mr-2"></i>Kembali</a>
                                            @if (in_array($level, $pelanggan_ajuanlimit))
                                                <a href="/limitkredit/{{ \Crypt::encrypt($data->kode_pelanggan) }}/create"
                                                    class="btn btn-outline-info mr-1 mb-1"><i
                                                        class="feather icon-external-link mr-2"></i>Ajukan Limit</a>
                                            @endif
                                        </div>
                                    </div>
