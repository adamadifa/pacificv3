                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Kode Pelanggan" field="kode_pelanggan" icon="feather icon-credit-card"
                                                    value="{{ $data->kode_pelanggan }}" readonly />
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                    ...
                                                    <input type="checkbox" class="na_nohp" @if ($data->no_hp == 'NA') checked @endif name="na_nohp"
                                                        value="1">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group @error('pasar') error @enderror">
                                                    <select name=" pasar" id="pasar" class="form-control select2">
                                                        ...
                                                        @foreach ($pasar as $d)
                                                            <option {{ $data->pasar == $d->nama_pasar ? 'selected' : '' }} value="{{ $d->nama_pasar }}">
                                                                {{ $d->nama_pasar }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('pasar')
                                        ...
                                        @if (Auth::user()->kode_cabang == 'PCF')
                                            <div class="row">
                                                <div class="col-12">
                                                    <x-inputtext label="Limit Pelanggan" field="limitpel" icon="feather icon-file"
                                                        value="{{ rupiah($data->limitpel) }}" right money />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group  @error('klasifikasi_outlet') error @enderror">
                                                <select name="klasifikasi_outlet" id="" class="form-control">
                                                    <option value="">Klasifikasi Outlet</option>
                                                    @foreach ($klasifikasioutlet as $d)
                                                        <option value="{{ $d->kode }}"
                                                            {{ $data->klasifikasi_outlet == $d->kode ? 'selected' : '' }}>{{ $d->klasifikasi }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('klasifikasi_outlet')
                                                    <div class="help-block">
                                                        <ul role="alert">
                                                            <li>{{ $message }}</li>
                                                        </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <x-inputtext label="Omset Toko" field="omset_toko" icon="feather icon-file" right
                                                value="{{ rupiah($data->omset_toko) }}" money />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group  @error('signature') error @enderror">
                                                <div class="custom-file">
                                                    <input type="file" name="signature" class="custom-file-input" id="inputGroupFile01">
                                                    <label class="custom-file-label" for="inputGroupFile01">Upload
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group  @error('signature_karyawan') error @enderror">
                                                <div class="custom-file">
                                                    <input type="file" name="signature_karyawan" class="custom-file-input" id="inputGroupFile01">
                                                    <label class="custom-file-label" for="inputGroupFile01">Upload
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <a href="{{ url()->previous() }}" class="btn btn-outline-warning mr-1 mb-1"><i
                                            ...
                                            @if (in_array($level, $pelanggan_ajuanlimit))
                                                <a href="/limitkredit/{{ \Crypt::encrypt($data->kode_pelanggan) }}/create"
                                                    class="btn btn-outline-info mr-1 mb-1"><i class="feather icon-external-link mr-2"></i>Ajukan
                                                    Limit</a>
                                            @endif
                                        </div>
                                    </div>
