                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <x-inputtext label="Kode Pelanggan" field="kode_pelanggan" icon="feather icon-credit-card" value="Auto"
                                                    readonly />
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="col-lg-6 col-sm-12">
                                                    <div class="form-group  @error('kode_cabang') error @enderror">
                                                        <select name="kode_cabang" id="kode_cabang" class="form-control">
                                                            ...
                                                            @foreach ($cabang as $c)
                                                                <option {{ old('kode_cabang') == $c->kode_cabang ? 'selected' : '' }}
                                                                    value="{{ $c->kode_cabang }}">
                                                                    {{ $c->nama_cabang }}
                                                                </option>
                                                            @endforeach
                                        ...
                                        <div class="col-12">
                                            <div class="form-group  @error('kepemilikan') error @enderror">
                                                <select name="kepemilikan" id="" class="form-control">
                                                    ...
                                                    <option @if (old('kepemilikan') == 'Milik Sendiri') selected @endif value="Milik Sendiri">Milik Sendiri
                                                    </option>
                                                </select>
                                                @error('kepemilikan')
                                                    <div class="help-block">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group  @error('cara_pembayaran') error @enderror">
                                                <select name="cara_pembayaran" id="" class="form-control">
                                                    ...
                                                    <option @if (old('cara_pembayaran') == '3') selected @endif value="3">Cheque / Bilyet Giro
                                                    </option>
                                                </select>
