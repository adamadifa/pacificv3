                           ...
                           <div class="form-body">
                              ...
                              <div class="row">
                                 <div class="col-lg-6 col-sm-12">
                                    <x-inputtext label="NIK" field="nik"
                                       icon="feather icon-credit-card" />
                                 </div>
                                 <div class="col-lg-6 col-sm-12">
                                    <x-inputtext label="No. KK" field="no_kk"
                                       icon="feather icon-credit-card" />
                                 </div>
                              </div>
                              <div class="row">
                              ...
                              <div class="row">
                                 <div class="col-12">
                                    <x-inputtext label="Alamat Toko" field="alamat_toko"
                                       icon="feather icon-map" />
                                 </div>
                              </div>
                              <div class="row">
                                 ...
                                 <div class="col-12">
                                    <div class="form-group @error('pasar') error @enderror"">
                                       <select name=" pasar" id="pasar" class="form-control select2">
                                          ...
                                          @foreach ($pasar as $d)
                                             <option value="{{ $d->nama_pasar }}">{{ $d->nama_pasar }}
                                             </option>
                                          @endforeach
                                       </select>
                                       @error('pasar')
                                 ...
                                 <div class="col-12">
                                    <div class="form-group  @error('hari') error @enderror">
                                       <select name="hari" id="" class="form-control">
                                          ...
                                          <option @if (old('hari') == 'Senin') selected @endif
                                             value="Senin">Senin</option>
                                          <option @if (old('hari') == 'Selasa') selected @endif
                                             value="Selasa">Selasa</option>
                                          <option @if (old('hari') == 'Rabu') selected @endif
                                             value="Rabu">Rabu</option>
                                          <option @if (old('hari') == 'Kamis') selected @endif
                                             value="Kamis">Kamis</option>
                                          <option @if (old('hari') == 'Jumat') selected @endif
                                             value="Jumat">Jumat</option>
                                          <option @if (old('hari') == 'Sabtu') selected @endif
                                             value="Sabtu">Sabtu</option>
                                          <option @if (old('hari') == 'Minggu') selected @endif
                                    ...
                                    <div class="col-12">
                                       <div class="form-group  @error('jatuhtempo') error @enderror">
                                          <select name="jatuhtempo" id="" class="form-control">
                                             ...
                                             <option @if (old('jatuhtempo') == '14') selected @endif
                                                value="14">14</option>
                                             <option @if (old('jatuhtempo') == '30') selected @endif
                                                value="30">30</option>
                                             <option @if (old('jatuhtempo') == '45') selected @endif
                                                value="45">45</option>
                                          </select>
                                          @error('jatuhtempo')
                                             <div class="help-block">
                                 ...
                                 <div class="row">
                                    <div class="col-12">
                                       <div class="form-group  @error('status_pelanggan') error @enderror">
                                          <select name="status_pelanggan" id=""
                                             class="form-control">
                                             <option value="">Status</option>
                                             <option @if (old('status_pelanggan') == '1') selected @endif
                                                value="1">AKTIF</option>
                                             <option @if (old('status_pelanggan') == '0') selected @endif
                              ...
                              <div class="col-12">
                                 <div class="form-group  @error('kepemilikan') error @enderror">
                                    <select name="kepemilikan" id="" class="form-control">
                                       ...
                                       <option @if (old('kepemilikan') == 'Sewa') selected @endif
                                          value="Sewa">Sewa</option>
                                       <option @if (old('kepemilikan') == 'Milik Sendiri') selected @endif
                              ...
                              <div class="col-12">
                                 <div class="form-group  @error('lama_usaha') error @enderror">
                                    <select name="lama_usaha" id="" class="form-control">
                                       ...
                                       <option @if (old('lama_usaha') == '< 2 Tahun') selected @endif
                                          value="< 2 Tahun">
                                          < 2 Tahun</option>
                                       <option @if (old('lama_usaha') == '2-5 Tahun') selected @endif
                                          value="2-5 Tahun">2-5 Tahun</option>
                                       <option @if (old('lama_usaha') == '> 5 Tahun') selected @endif
                              ...
                              <div class="col-12">
                                 <div class="form-group  @error('status_outlet') error @enderror">
                                    <select name="status_outlet" id="" class="form-control">
                                       ...
                                       <option @if (old('status_outlet') == '1') selected @endif
                                          value="1">New Outlet</option>
                                       <option @if (old('status_outlet') == '2') selected @endif
                              ...
                              <div class="col-12">
                                 <div class="form-group  @error('type_outlet') error @enderror">
                                    <select name="type_outlet" id="" class="form-control">
                                       ...
                                       <option @if (old('type_outlet') == '1') selected @endif
                                          value="1">Grosir</option>
                                       <option @if (old('type_outlet') == '2') selected @endif
                              ...
                              <div class="col-12">
                                 <div class="form-group  @error('cara_pembayaran') error @enderror">
                                    <select name="cara_pembayaran" id="" class="form-control">
                                       ...
                                       <option @if (old('cara_pembayaran') == '1') selected @endif
                                          value="1">Bank Transfer</option>
                                       <option @if (old('cara_pembayaran') == '2') selected @endif
                                          value="2">Advance Cash</option>
                                       <option @if (old('cara_pembayaran') == '3') selected @endif
                              ...
                              <div class="col-12">
                                 <div class="form-group  @error('lama_langganan') error @enderror">
                                    <select name="lama_langganan" id="" class="form-control">
                                       ...
                                       <option @if (old('lama_langganan') == '< 2 Tahun') selected @endif
                                          value="< 2 Tahun">
                                          < 2 Tahun</option>
                                       <option @if (old('lama_langganan') == '> 2 Tahun') selected @endif
                              ...
                              <div class="col-12">
                                 <div class="form-group  @error('jaminan') error @enderror">
                                    <select name="jaminan" id="" class="form-control">
                                       ...
                                       <option @if (old('jaminan') == '1') selected @endif
                                          value="1">Ada</option>

                                       <option @if (old('jaminan') == '2') selected @endif
