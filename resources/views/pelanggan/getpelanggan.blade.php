        ...
        <div class="content-body" id="loadpelanggan">
            ...
            @else
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    <div class="btn-group">
                                        <a href="/pelanggan/{{ \Crypt::encrypt($pelanggan->kode_pelanggan) }}/edit"
                                            class="btn btn-success  text-right mb-2" style="padding: 15px !important"><i
                                                class="feather icon-edit"></i></a>
                                        <a href="/pelanggan/{{ Crypt::encrypt($pelanggan->kode_pelanggan) }}/capturetoko"
                                            class="btn btn-primary  text-right mb-2" style="padding: 15px !important"><i
                                                class="feather icon-camera"></i></a>
                                        <a href="/limitkredit/{{ \Crypt::encrypt($pelanggan->kode_pelanggan) }}/create"
                                            class="btn btn-warning  text-right mb-2" style="padding: 15px !important"><i
                                                class="feather icon-file-text"></i> </a>
                                        <a href="/ajuanfaktur/{{ \Crypt::encrypt($pelanggan->kode_pelanggan) }}/createfromsales"
                                            class="btn btn-info  text-right mb-2" style="padding: 15px !important"><i class="feather icon-file-text"></i>
                                        </a>
                                    </div>
                                    <div>
                                        @if ($salesmancheckin != 0)
                                            <a href="/pelanggan/{{ Crypt::encrypt($pelanggan->kode_pelanggan) }}/checkout"
                                                class="btn btn-danger  text-right mb-2" style="padding: 15px !important"><i
                                                    class="feather icon-log-out mr-1"></i>Check Out</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        @if ($pelanggan->foto != null)
                                            <img class="card-img-top img-fluid" style="height: 250px; object-fit:cover" id="foto"
                                                src="{{ url(Storage::url('pelanggan/' . $pelanggan->foto)) }}" alt="Card image cap">
                                        @else
                                        ...
                                        <div class="card-img-overlay overflow-hidden overlay-primary overlay-darken-5">
                                            ...
                                            <h4 class="card-title text-white">{{ $pelanggan->kode_pelanggan }} <br>
                                                {{ strtoupper($pelanggan->nama_pelanggan) }}</h4>
                ...
                @else --}}
                                        @if ($getcbg == 'BKI')
                                            <div class="col-6">
                                                <a href="/inputpenjualanv2" class="btn btn-success btn-block"><i
                                                        class="feather icon-shopping-cart mr-1"></i>INC. PPN</a>
                                            </div>
                                            <div class="col-6">
                                                <a href="/inputpenjualanppn" class="btn btn-success btn-block"><i
                                                        class="feather icon-shopping-cart mr-1"></i>EXC. PPN</a>
                                            </div>
                                            <div class="col-12 mt-2">
                                                <a href="/retur/createv2" class="btn btn-danger btn-block"><i
                                                        class="feather icon-refresh-cw mr-1"></i>Retur</a>
                                            </div>
                                        @else
                                            <div class="col-6">
                                                <a href="/inputpenjualanv2" class="btn btn-success btn-block"><i
                                                        class="feather icon-shopping-cart mr-1"></i>Penjualan</a>
                                            </div>
                                            <div class="col-6">
                                                <a href="/retur/createv2" class="btn btn-danger btn-block"><i
                                                        class="feather icon-refresh-cw mr-1"></i>Retur</a>
                                    ...
                                    @else
                                        <div class="col-12" id="checkinsection">
                                            <span id="latitude" class="d-none"></span>
                                            <input type="hidden" id="lokasi">
                                            <a href="#" id="checkin" class="btn btn-success btn-block"><i
                                                    class="feather icon-lock mr-1"></i>Checkin</a>
                                        </div>
                                    @endif
                                @else
                                    <div class="col-12" id="checkinsection">
                            ...
                            <div class="app-fixed-search mb-2">
                                <form action="{{ url()->current() }}" method="GET">
                                    ...
                                    <fieldset class="form-group position-relative has-icon-left m-0 mb-1">
                                        <input type="text" class="form-control" name="no_fak_penj" value="{{ Request('no_fak_penj') }}"
                                            id="nama_pelanggan" placeholder="Cari No. Faktur" autocomplete="off">
