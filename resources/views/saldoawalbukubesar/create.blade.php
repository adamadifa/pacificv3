...
@section('titlepage','Input Saldo Awal Buku Besar')
@section('content')
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Input Saldo Awal Buku Besar</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/saldoawalbb/create">Input Saldo Awal Buku Besar</a>
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="content-body">
        ...
        <div class="col-md-12 col-sm-8 col-lg-6">
            <div class="card">
                <div class="card-body">
                    <form action="/saldoawalbb/store" method="POST" id="frm">
                        @csrf
    ...
    $(function() {
        function loaddetailsaldo() {
            ...
            if (bulan == "") {
                ...
                $.ajax({
                    type: 'POST'
                    , url: '/saldoawalbb/getdetailsaldo'
                    , data: {
                        _token: "{{ csrf_token() }}"
                        , bulan: bulan
                        , tahun: tahun
