                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <ul class="list-unstyled users-list m-0  d-flex align-items-center showactivity" kode_act_sm="{{ $d->kode_act_sm }}">
...
<div class="modal fade text-left" id="mdlshowactivity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18" aria-hidden="true">
