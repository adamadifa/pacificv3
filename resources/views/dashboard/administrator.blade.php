                        ...
                        <div class="card text-center">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 line-ellipsis">Ajuan Limit Kredit
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <h1 class="text-bold-700"><a
                                            href="/ajuanrouting?status=pending">{{ $jmlpengajuanrouting }}</a></h1>
                                    <p class="mb-0 line-ellipsis">Ajuan Routing
                                        {{ ucwords(Auth::user()->level) }}<br><br><br></p>
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Rekap Analisa Umur Piutang</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="form-body">
