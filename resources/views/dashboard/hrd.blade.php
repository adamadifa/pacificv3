                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <ul class="nav nav-tabs nav-justified" id="myTab2" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link" id="kontraklewat-tab-justified" data-toggle="tab"
                                                        href="#kontrak-lewat" role="tab" aria-controls="kontrak-lewat"
                                                        aria-selected="false">Lewat JT<span
                                                            class="badge badge-pill bg-danger ml-1">{{ $jml_kontrak_lewat }}</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="kontrakbulanini-tab-justified"
                                                        data-toggle="tab" href="#kontrak-bulanini" role="tab"
                                                        aria-controls="kontrak-bulanini" aria-selected="true">Bulan Ini
                                                        <span
                                                            class="badge badge-pill bg-danger ml-1">{{ $jml_kontrak_bulanini }}</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="profile-tab-justified" data-toggle="tab"
                                                        href="#kontrak-bulandepan" role="tab"
                                                        aria-controls="kontrak-bulandepan" aria-selected="false">Bulan Depan
                                                        <span class="badge badge-pill bg-warning ml-1">
                                                            {{ $jml_kontrak_bulandepan }}</span></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="messages-tab-justified" data-toggle="tab"
                                                        href="#kontrak-duabulan" role="tab"
                                                        aria-controls="kontrak-duabulan" aria-selected="false">2 Bulan
                                                        Lagi <span
                                                            class="badge badge-pill bg-success">{{ $jml_kontrak_duabulan }}</span></a>
                                                </li>
                                            </ul>
                                            <div class="tab-content pt-1">
                                                <div class="tab-pane" id="kontrak-lewat" role="tabpanel"
                                                    aria-labelledby="kontraklewat-tab-justified">
                                                ...
                                                <div class="tab-pane active" id="kontrak-bulanini" role="tabpanel"
                                                    aria-labelledby="kontrakbulanini-tab-justified">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <th>NIK</th>
                                                ...
                                                <div class="tab-pane" id="kontrak-bulandepan" role="tabpanel"
                                                    aria-labelledby="kontraklewat-tab-justified">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                ...
                                                <div class="tab-pane" id="kontrak-duabulan" role="tabpanel"
                                                    aria-labelledby="kontraklewat-tab-justified">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                        ...
                                        <div class="card text-center">
                                            <div class="card-content">
                                                <div class="card-body">
                                                    <div class="avatar bg-rgba-success p-50 m-0 mb-1">
                                                        <div class="avatar-content">
                                                            <img src="{{ asset('app-assets/images/logo/mp.png') }}"
                                        ...
                                        <div class="card text-center">
                                            <div class="card-content">
                                                <div class="card-body">
                                                    <div class="avatar bg-rgba-info p-50 m-0 mb-1">
                                                        <div class="avatar-content">
                                                            <img src="{{ asset('app-assets/images/logo/pcf.png') }}"
                                                                width="30px" height="30px" alt="">
                                                        </div>
                                                    </div>
