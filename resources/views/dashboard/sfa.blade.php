                                    ...
                                    <tbody style="font-size: 11px">
                                        ...
                                        <td>{{ $d->nama_karyawan }}</td> --}}
                                                ...
                                                <td class="text-center">
                                                    {{ !empty($d->qty_AR) && $d->qty_AR > 0 ? desimal($d->qty_AR) : '' }}
                                                </td>
                                                <td class="text-center">
                                                    {{ !empty($d->qty_AS) && $d->qty_AS > 0 ? desimal($d->qty_AS) : '' }}
                                                </td>
                                                <td class="text-center">
                                                    {{ !empty($d->qty_AB) && $d->qty_AB > 0 ? desimal($d->qty_AB) : '' }}
                                                </td>
                                                <td class="text-center">
                                                    {{ !empty($d->qty_BB) && $d->qty_BB > 0 ? desimal($d->qty_BB) : '' }}
                                                </td>
                                                <td class="text-center">
                                                    {{ !empty($d->qty_DEP) && $d->qty_DEP > 0 ? desimal($d->qty_DEP) : '' }}
                                                </td>
                                                <td class="text-center">
                                                    {{ !empty($d->qty_SP8) && $d->qty_SP8 > 0 ? desimal($d->qty_SP8) : '' }}
                                                </td>
                                                <td class="text-center">
                                                    {{ !empty($d->qty_SP) && $d->qty_SP > 0 ? desimal($d->qty_SP) : '' }}
                                                </td>
                                                <td class="text-center">
                                                    {{ !empty($d->qty_SP500) && $d->qty_SP500 > 0 ? desimal($d->qty_SP500) : '' }}
                                                </td>
                                                <td class="text-center">
                                                    {{ !empty($d->qty_SC) && $d->qty_SC > 0 ? desimal($d->qty_SC) : '' }}
                                                </td>
                                                <td class="text-right">
                                                    {{ !empty($d->jml_tunai) ? rupiah($d->jml_tunai) : '' }}</td>
                                                <td class="text-right">
                                                    {{ !empty($d->jml_kredit) ? rupiah($d->jml_kredit) : '' }}</td>
                                                <td class="text-right">
                                                    {{ !empty($d->bayar_tunai) ? rupiah($d->bayar_tunai) : '' }}</td>
                                                <td class="text-right">
                                                    {{ !empty($d->bayar_titipan) ? rupiah($d->bayar_titipan) : '' }}</td>
                                                <td class="text-right">
                                                    {{ !empty($d->bayar_transfer) ? rupiah($d->bayar_transfer) : '' }}</td>
                                                <td class="text-right">
                                                    {{ !empty($d->bayar_giro) ? rupiah($d->bayar_giro) : '' }}</td>
                                                <td class="text-right">
                                                    {{ !empty($d->bayar_voucher) ? rupiah($d->bayar_voucher) : '' }}</td>
                                                <td>{{ !empty($d->tgltransaksi) ? date('d-m-y', strtotime($d->tgltransaksi)) : '' }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
