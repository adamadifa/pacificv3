            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/mutasigudangcabang/transitin">Data {{ strtoupper($textjm) }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <table class="table table-hover-animation">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $d->kode_cabang }}</td>
                                                <td>{{ ucwords(strtolower($d->tujuan)) }}</td>
                                                <td>{{ $d->no_kendaraan }}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="#" class="ml-1 edit" no_mutasi_gudang_cabang="{{ Crypt::encrypt($d->no_mutasi_gudang_cabang) }}"><i class="feather icon-edit success"></i></a>
                                                        <a href="#" class="ml-1 detail" no_mutasi_gudang_cabang="{{ Crypt::encrypt($d->no_mutasi_gudang_cabang) }}"><i class="feather icon-file-text info"></i></a>
...
<script>
    $(function() {
        ...
        function loaddetail(no_mutasi_gudang_cabang) {
            $("#loaddetail").load("/mutasigudangcabang/" + no_mutasi_gudang_cabang + "/show");
        }
        ...
        function loadedit(no_mutasi_gudang_cabang) {
            $("#loadedit").load("/mutasigudangcabang/" + no_mutasi_gudang_cabang + "/edit");
        }
        ...
        $("#inputmutasi").click(function(e) {
            ...
            $("#loadinput").load("/mutasigudangcabang/" + jenis_mutasi + "/create");
            $('#mdlinput').modal({
                backdrop: 'static'
                , keyboard: false
            });
