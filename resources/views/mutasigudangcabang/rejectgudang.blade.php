...
@section('content')
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="#" class="btn btn-primary" id="inputmutasi"><i
                                            ...
                                            <tbody>
                                                @foreach ($mutasi as $d)
                                                    <tr>
                                                        ...
                                                        <td>{{ date('d-m-Y', strtotime($d->tgl_mutasi_gudang_cabang)) }}
                                                        </td>
                                                        <td>{{ $d->no_suratjalan }}</td>
                                                        <td>{{ $d->no_dok }}</td>
                                                        <td>{{ $d->kode_cabang }}</td>
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="#" class="ml-1 edit"
                                                                    no_mutasi_gudang_cabang="{{ Crypt::encrypt($d->no_mutasi_gudang_cabang) }}"><i
                                                                        class="feather icon-edit success"></i></a>
                                                                <a href="#" class="ml-1 detail"
                                                                    no_mutasi_gudang_cabang="{{ Crypt::encrypt($d->no_mutasi_gudang_cabang) }}"><i
                                                                        class="feather icon-file-text info"></i></a>
                                                                <form method="POST" class="deleteform"
                                                                    action="/mutasigudangcabang/{{ Crypt::encrypt($d->no_mutasi_gudang_cabang) }}/delete">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <a href="#"
                                                                        tanggal="{{ $d->tgl_mutasi_gudang_cabang }}"
    ...
    <!-- Detail Surat Jalan -->
    <div class="modal fade text-left" id="mdldetail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
    ...
    <div class="modal fade text-left" id="mdledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        $(function() {
            ...
            function loadedit(no_mutasi_gudang_cabang) {
                $("#loadedit").load("/mutasigudangcabang/" + no_mutasi_gudang_cabang + "/mutasiedit");
            }
            ...
            $("#inputmutasi").click(function(e) {
                ...
                $("#loadinput").load("/mutasigudangcabang/" + jenis_mutasi + "/rejectgudangcreate");
                $('#mdlinput').modal({
                    backdrop: 'static',
                    keyboard: false
                });
