...
<form action="/rejectgudang/store" method="post" id="frmDpb">
    ...
    <div class="row">
        <div class="col-12">
            <x-inputtext field="no_sj_search" label="Ketikan No. SJ / No. Dok / Tanggal SJ" icon="fa fa-barcode" />
    ...
    <div class="row">
        <div class="col-12" id="loadsuratjalan">
...
<script>
    $(function() {
        ...
        $("#frmDpb").find("#no_sj_search").autocomplete({
