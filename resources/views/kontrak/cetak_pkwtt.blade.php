...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{ $kontrak->tempat_lahir }},
                    {{ !empty($kontrak->tgl_lahir) ? DateToIndo2($kontrak->tgl_lahir) : '' }}</td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>:</td>
        ...
        Pihak kesatu dan pihak kedua telah mengadakan kesepakatan Perjanjian Kerja Waktu Tidak Tertentu dengan ketentuan
        sebagai berikut:
        ...
        <ol>
            ...
            <li>
                Pihak kedua ditempatkan sebagai <b>{{ $kontrak->nama_jabatan }}
                    {{ $kontrak->id_kantor == 'PST' ? 'KANTOR PUSAT TASIKMALAYA' : 'CABANG ' . strtoupper($kontrak->nama_cabang) }}</b>
                ...
                @else
                    @php
                        $totalgaji =
                            ...
                            $kontrak->t_skill;
                    @endphp
                    Pihak kedua setuju menerima upah sebesar Rp {{ rupiah($totalgaji) }} ,- dengan rincian sebagai
                    berikut :
                    <table>
                        <tr>
                            <td>a.</td>
