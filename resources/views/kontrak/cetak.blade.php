...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        Pihak kesatu dan pihak kedua telah mengadakan kesepakatan Perjanjian Kerja Waktu Tertentu dengan ketentuan
        sebagai berikut:
        ...
        <ol>
            <li>
                ...
                @endphp
                , terhitung dari tanggal {{ DateToIndo2($kontrak->dari) }} sampai dengan tanggal
        ...
        <table class="datatable4">
            <tr>
                <td colspan="3" style="text-align: center">
                    {{ $cabang->kode_cabang != 'PST' ? ucwords($cabang->nama_cabang) : 'Tasikmalaya' }},{{ DateToIndo2($kontrak->dari) }}
                </td>
            </tr>
            <tr>
