...
<body class="body-scroll" data-page="index">
                ...
                <li class="nav-item centerbutton">
                    <div class="nav-link">
                        ...
                        <div class="nav-menu-popover justify-content-between">
                            ...
                            <button type="button" class="btn btn-lg btn-icon-text" onclick="window.location.replace('bills.html');">
    ...
    <script src="{{ asset('sap/ssets/vendor/progressbar-js/progressbar.min.js') }}"></script>
