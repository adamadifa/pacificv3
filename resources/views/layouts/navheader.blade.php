             ...
             <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                <ul class="nav navbar-nav">
                   ...
                   @if (Auth::user()->level == 'salesman' && !request()->is(['home']))
                      <li class="nav-item d-xl-none mr-auto"><a class="nav-link hidden-xs" href="#"
                            id="refresh"><i class="ficon feather icon-refresh-cw"></i></a></li>
                   @endif
                   ...
                   <li class="dropdown dropdown-user nav-item"><a
                         ...
                         <div class="user-nav d-sm-flex d-none"><span
                            ...
                            @if (!empty(Auth::user()->foto))
                               ...
                               <img class="round" src="{{ url($path) }}" alt="avatar" height="40"
                                  width="40">
                            @else
                               <img class="round"
                      ...
                      <li class="dropdown dropdown-user nav-item"><a
                            ...
                            <div class="user-nav d-sm-flex d-none"><span
                               ...
                               @if (!empty(Auth::user()->foto))
                                  ...
                                  <img class="round" src="{{ url($path) }}" alt="avatar"
                                     height="40" width="40">
                               @else
                                  <img class="round"
                                     src="{{ asset('app-assets/images/portrait/small/avatar-s-11.jpg') }}"
