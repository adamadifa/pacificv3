            ...
            <tbody>
                ...
                @foreach ($setoranpenjualan as $key => $d)
                    ...
                    <tr>
                        ...
                        <td style="text-align:right"><u><a class="text-white" target="_blank"
                        ...
                        <td style="text-align:right"><a href="#" class="detailkertas" data-toggle="popover" data-placement="{{ $position }}" data-container="body"
                                data-original-title="Keterangan" data-content="{{ $kontenkertas }}">{{ !empty($d->setoran_kertas + $uk) ? rupiah($d->setoran_kertas + $uk) : '' }}</a></td>
                        <td style="text-align:right"><a href="#" class="detaillogam" data-toggle="popover" data-placement="{{ $position }}" data-container="body"
                                data-original-title="Keterangan" data-content="{{ $kontenlogam }}">{{ !empty($d->setoran_logam + $ul) ? rupiah($d->setoran_logam + $ul) : '' }}</a></td>
