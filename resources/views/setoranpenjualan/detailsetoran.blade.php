...
<head>
    ...
    <title>Detail Setoran {{ $salesman->nama_karyawan }} Tanggal {{ DateToIndo2($tgl_lhp) }}</title>
    <style>
        body {
            font-family: 'Poppins'
        }
...
<body>
    <b style="font-size: 14px">
        ...
        KAS BESAR <br>
        TANGGAL {{ DateToIndo2($tgl_lhp) }}<br>
    ...
    <br>
    <h4>LIST GIRO <br> TANGGAL <?php echo DateToIndo2($tgl_lhp); ?><br></h4>
    <table class="datatable3">
        <thead bgcolor="#024a75" style="color:white; font-size:12;">
            <tr bgcolor="#024a75" style="color:white; font-size:12;">
                <th>No Giro</th>
    ...
    <br>
    <h4>LIST TRANSFER <br> TANGGAL <?php echo DateToIndo2($tgl_lhp); ?><br></h4>
    <table class="datatable3">
