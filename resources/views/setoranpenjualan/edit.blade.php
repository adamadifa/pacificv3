<form action="/setoranpenjualan/{{ Crypt::encrypt($setoranpenjualan->kode_setoran) }}/update" method="POST" id="frmSetoranpenjualan">
    @csrf
    <input type="hidden" id="cektutuplaporan">
    <input type="hidden" id="ceksetoran" name="ceksetoran">
    <div class="row">
        <div class="col-12">
            <x-inputtext label="Tanggal LHP" field="tgl_lhp" icon="feather icon-calendar" value="{{ $setoranpenjualan->tgl_lhp }}" datepicker disabled />
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-12 col-sm-12">
            <div class="form-group  ">
                <select name="kode_cabang" id="kode_cabang" class="form-control" disabled>
                    ...
                    @foreach ($cabang as $c)
                    <option {{ ($setoranpenjualan->kode_cabang ==$c->kode_cabang ? 'selected':'')}} value="{{
    ...
    <div class="row" id="pilihsalesman">
        <div class="col-12">
            <div class="form-group  ">
                <select name="id_karyawan" id="id_karyawan" class="form-control" disabled>
    ...
    <div class="row">
        <div class="col-12">
            <x-inputtext label="Setoran Uang Kertas" field="setoran_kertas" icon="feather icon-file" value="{{ rupiah($setoranpenjualan->setoran_kertas) }}" right />
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <x-inputtext label="Setoran Uang Logam" field="setoran_logam" icon="feather icon-file" value="{{ rupiah($setoranpenjualan->setoran_logam) }}" right />
        </div>
    </div>
    <div class="row">
        <div class="col-12">
...
<script>
    $(function() {
        ...
        function loadsalesmancabang(kode_cabang) {
            var id_karyawan = "{{ $setoranpenjualan->id_karyawan }}";
            $.ajax({
                type: 'POST'
