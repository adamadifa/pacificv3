            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <a href="#" class="btn btn-primary" id="inputsetoranpenjualan"><i class="fa fa-plus mr-1"></i>
                            Tambah Data</a>
                    </div>
                    <div class="card-body">
                        ...
                        <a href="/setoranpenjualan/cetak?dari={{ Request('dari') }}&sampai={{ Request('sampai') }}&kode_cabang={{ Request('kode_cabang') }}&id_karyawan={{ Request('id_karyawan') }}&excel=false"
                            target="_blank" class="btn btn-primary"><i class="feather icon-printer"></i></a>
                        <a href="/setoranpenjualan/cetak?dari={{ Request('dari') }}&sampai={{ Request('sampai') }}&kode_cabang={{ Request('kode_cabang') }}&id_karyawan={{ Request('id_karyawan') }}&excel=true"
                            ...
                            <tbody>
                                ...
                                @foreach ($setoranpenjualan as $key => $d)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ !empty($d->setoran_transfer) ? rupiah($d->setoran_transfer) : '' }}</td>
                                        <td class="text-right">
                                            {{ !empty($d->setoran_lainnya) ? rupiah($d->setoran_lainnya) : '' }}</td>
                                ...
                                <th style='text-align:right'>" .
                                                ...
                                                "</th>
                                <th style='text-align:right'>" .
                                                number_format($totallhppertgl, '0', '', '.') .
                                                "</th>
                                <th style='text-align:right'>" .
                                                number_format($totalsetorankertas, '0', '', '.') .
                                                "</th>
                                <th style='text-align:right'>" .
                                                number_format($totalsetoranlogam, '0', '', '.') .
                                                "</th>
                                <th style='text-align:right'>" .
                                                number_format($totalsetoranbg, '0', '', '.') .
                                                "</th>
                                <th style='text-align:right'>" .
                                                number_format($totalsetorantransfer, '0', '', '.') .
                                                "</th>
                                <th style='text-align:right'>" .
                                                number_format($totalsetoranlainnya, '0', '', '.') .
                                                "</th>
                                <th style='text-align:right'>" .
                                                number_format($totalsetoranpertgl, '0', '', '.') .
                                                "</th>
                                <th></th>
                            </tr>";
