                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            @php
                                                $hariini = date('Y-m-d');
                                            @endphp
                                            <x-inputtext label="Tanggal Pengajuan" field="tgl_pengajuan" value="{{ $hariini }}"
                                                icon="feather icon-calendar" datepicker />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <x-inputtext label="Kode Pelanggan" field="kode_pelanggan" icon="fa fa-barcode"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <x-inputtext label="Nama Pelanggan" field="nama_pelanggan" icon="fa fa-barcode"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select id="hari" name="hari" class="form-control">
                                                    ...
                                                    <option @if ($pelanggan->hari == 'Senin') selected @endif value="Senin">Senin</option>
                                                    <option @if ($pelanggan->hari == 'Selasa') selected @endif value="Selasa">Selasa</option>
                                                    <option @if ($pelanggan->hari == 'Rabu') selected @endif value="Rabu">Rabu</option>
                                                    <option @if ($pelanggan->hari == 'Kamis') selected @endif value="Kamis">Kamis</option>
                                                    <option @if ($pelanggan->hari == 'Jumat') selected @endif value="Jumat">Jumat</option>
                                                    <option @if ($pelanggan->hari == 'Sabtu') selected @endif value="Sabtu">Sabtu</option>
                                                    <option @if ($pelanggan->hari == 'Minggu') selected @endif value="Minggu">Minggu</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <x-inputtext label="Cabang" field="kode_cabang" icon="fa fa-bank" value="{{ $pelanggan->kode_cabang }}"
                                                readonly />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <x-inputtext label="Salesman" field="id_karyawan" icon="feather icon-users"
                                                value="{{ $pelanggan->nama_karyawan }}" readonly />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select name="status_outlet" id="status_outlet" class="form-control">
                                                    ...
                                                    <option @if ($pelanggan->status_outlet == 1) selected @endif value="1">New Outlet</option>
                                                    <option @if ($pelanggan->status_outlet == 2) selected @endif value="2">Exsiting Outlet</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select name="type_outlet" id="type_outlet" class="form-control">
                                                    ...
                                                    <option @if ($pelanggan->type_outlet == 1) selected @endif value="1">Grosir</option>
                                                    <option @if ($pelanggan->type_outlet == 2) selected @endif value="2">Retail</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select name="klasifikasi_outlet" id="klasifikasi_outlet" class="form-control">
                                                    <option value="">Klasifikasi Outlet</option>
                                                    @foreach ($klasifikasioutlet as $d)
                                                        <option value="{{ $d->kode }}">{{ $d->klasifikasi }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select name="jatuhtempo" id="jatuhtempo" class="form-control">
                                                    ...
                                                    <option @if ($pelanggan->jatuhtempo == 14) selected @endif value="14">14</option>
                                                    <option @if ($pelanggan->jatuhtempo == 30) selected @endif value="30">30</option>
                                                    <option @if ($pelanggan->jatuhtempo == 45) selected @endif value="45">45</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select name="cara_pembayaran" id="cara_pembayaran" class="form-control">
                                                    ...
                                                    <option @if ($pelanggan->cara_pembayaran == 1) selected @endif value="1">Bank Transfer</option>
                                                    <option @if ($pelanggan->cara_pembayaran == 2) selected @endif value="2">Advance Cash</option>
                                                    <option @if ($pelanggan->cara_pembayaran == 3) selected @endif value="3">Cheque / Bilyet Giro
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select name="kepemilikan" id="kepemilikan" class="form-control">
                                                    ...
                                                    <option @if ($pelanggan->kepemilikan == 'Milik Sendiri') selected @endif value="Milik Sendiri">Milik Sendiri
                                                    </option>
                                                    <option @if ($pelanggan->kepemilikan == 'Sewa') selected @endif value="Sewa">Sewa</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <x-inputtext label="Terakhir Top Up" field="topup_terakhir" icon="feather icon-calendar"
                                                value="{{ $lasttopupdate }}" datepicker />
                                        </div>
                                        <div class="col-lg-6 col-sm-12">

                                            <x-inputtext label="Usia Top Up" field="usia_topup" icon="feather icon-file" value="{{ $usia_topup }}"
                                                readonly />
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <select name="jaminan" id="jaminan" class="form-control">
                                                    ...
                                                    <option @if ($pelanggan->jaminan == 1) selected @endif value="1">Ada</option>
                                                    <option @if ($pelanggan->jaminan == 2) selected @endif value="2">Tidak Ada</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <x-inputtext label="Omset Toko" field="omset_toko" icon="feather icon-file" right
                                                value="{{ rupiah($pelanggan->omset_toko) }}" />
                                        </div>
                                    </div>
                                    <div class="divider divider-left">
    ...
    <script>
        $(function() {
            ...
            function loadSkor() {
                ...
                var totalscore = parseFloat(score_outlet) + parseFloat(score_top) + parseFloat(score_carabayar) + parseFloat(score_kepemilikan) +
                    parseFloat(score_lamausaha) + parseFloat(
                        score_jaminan) +
                    parseFloat(score_lamatopup) + parseFloat(score_lamalangganan) + parseFloat(score_ht) + parseFloat(score_omset) + parseFloat(
                        score_faktur) + parseFloat(score_typeoutlet);
