                              ...
                              <div class="col-12">
                                 <div class="form-group">
                                    <select name="cara_pembayaran" id="cara_pembayaran" class="form-control">
                                       ...
                                       <option @if ($pelanggan->cara_pembayaran == 3) selected @endif value="3">Cheque / Bilyet Giro</option>
                                    </select>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="col-12">
                                 <div class="form-group">
                                    <select name="kepemilikan" id="kepemilikan" class="form-control">
                                       ...
                                       <option @if ($pelanggan->kepemilikan == 'Milik Sendiri') selected @endif value="Milik Sendiri">Milik Sendiri</option>
   ...
   <script>
      $(function() {
         ...
         function loadSkor() {
            ...
            var totalscore = parseFloat(score_outlet) + parseFloat(score_top) + parseFloat(score_carabayar) + parseFloat(score_kepemilikan) + parseFloat(score_lamausaha) + parseFloat(
               score_jaminan) +
