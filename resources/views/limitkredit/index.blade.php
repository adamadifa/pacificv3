...
@section('content')
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    @if ($d->status != 2)
                                                        @if (empty($d->jumlah_rekomendasi) || $d->jumlah_rekomendasi === 0)
                                                            <a href="#" class="penyesuaian_limit"
                                                                no_pengajuan="{{ $d->no_pengajuan }}"><i
                                                                    class="feather icon-maximize-2 info"></i></a>
                                                        @else
                                                            @if ($d->jumlah_rekomendasi > $d->jumlah)
                                                                ...
                                                                @if ($d->cek_ajuan == 1)
                                                                    <a href="#" class="#"
                                                                        no_pengajuan="{{ $d->no_pengajuan }}"><i
                                                                            class="feather icon-arrow-up-right success"></i>
                                                                        <span class="success">{{ round($persentase, 2) }}
                                                                            %</span></a>
                                                                @else
                                                                    <a href="#" class="penyesuaian_limit"
                                                                        no_pengajuan="{{ $d->no_pengajuan }}"><i
                                                            ...
                                                            @else
                                                                ...
                                                                @if ($d->cek_ajuan == 1)
                                                                    <a href="#" class="#"
                                                                        no_pengajuan="{{ $d->no_pengajuan }}"><i
                                                                            class="feather icon-arrow-down-left danger"></i>
                                                                        <span class="danger">{{ round($persentase, 2) }}
                                                                            %</span></a>
                                                                @else
                                                                    <a href="#" class="penyesuaian_limit"
                                                                        no_pengajuan="{{ $d->no_pengajuan }}"><i
                                            ...
                                            <td>
                                                ...
                                                if ($scoreakhir <= 2) {
                                                    ...
                                                    $rekomendasi = 'TD';
                                                } elseif ($scoreakhir > 4 && $scoreakhir <= 6) {
                                                    $rekomendasi = 'B';
                                                } elseif ($scoreakhir > 6 && $scoreakhir <= 8.5) {
                                                    $rekomendasi = 'LDP';
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a href="/limitkredit/{{ Crypt::encrypt($d->no_pengajuan) }}/cetak"
                                                        target="_blank"><i class="feather icon-printer info"></i></a>
                                                    @if ($d->cek_ajuan != 1)
                                                        {{-- <a class="ml-1" href="#"><i class=" feather icon-edit success"></i></a> --}}
                                                        @if (in_array($level, $limitkredit_hapus))
                                                            @if (empty($d->kacab))
                                                                <form method="POST" name="deleteform" class="deleteform"
                                                                    action="/limitkredit/{{ Crypt::encrypt($d->no_pengajuan) }}/{{ Crypt::encrypt($d->kode_pelanggan) }}/delete">
                                                                    @csrf
                                                                    @method('DELETE')
                                                        ...
                                                        @if (in_array($level, $limitkredit_analisa))
                                                            @if ($d->status == 0)
                                                                <a class="ml-1 uraiananalisa"
                                                                    no_pengajuan="{{ $d->no_pengajuan }}"
                                                                    href="#"><i
                                                                        class=" feather icon-message-circle primary"></i></a>
                                                            @endif
                                                        @endif
                                                        <!-- Kepala Cabang -->
                                                        @if (
                                                            ...
                                                            <a class="ml-1"
                                                                href="/limitkredit/{{ Crypt::encrypt($d->no_pengajuan) }}/approve"><i
                                                                    class=" fa fa-check success"></i></a>
                                                            <a class="ml-1"
                                                                href="/limitkredit/{{ Crypt::encrypt($d->no_pengajuan) }}/decline"><i
                                                                    class=" fa fa-close danger"></i></a>
                                                        @endif

                                                        {{-- @if (($level == 'kepala penjualan' && empty($d->kacab) && $d->status == 0) || ($level == 'kepala penjualan' && !empty($d->kacab) && empty($d->rsm) && $d->status == 2) || ($level == 'kepala penjualan' && !empty($d->kacab) && empty($d->rsm) && $d->status == 1) || ($level == 'kepala penjualan' && !empty($d->kacab) && empty($d->rsm) && $d->status == 0))
    ...
    <div class="modal fade text-left" id="mdluraiananalisa" tabindex="-1" role="dialog"
    ...
    <div class="modal fade text-left" id="mdlpenyesuaianlimit" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel18" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
