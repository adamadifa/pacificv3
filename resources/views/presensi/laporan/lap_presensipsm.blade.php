                ...
                <div class="col-lg-9 col-sm-12">
                    <div class="row">
                        <div class="col-lg-7 col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="/laporanhrd/presensipsm/cetak" method="POST" id="frmPresensi" target="_blank">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <select name="jenis_laporan" required id="jenis_laporan" class="form-control">
