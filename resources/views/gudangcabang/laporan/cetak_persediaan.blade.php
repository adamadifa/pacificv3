        ...
        <tbody>
            ...
            @foreach ($mutasi as $m)
                @php
                    ...
                    $saldoakhirfix = $realsaldoakhir < 0 ? $realsaldoakhir * -1 : $realsaldoakhir;
                    if ($m->inout_good == 'IN') {
                        $color_sa = '#28a745';
                    } else {
                        $color_sa = '#c7473a';
                    ...
                    if ($saldoakhirfix != 0) {
                        $jmldus = floor($saldoakhirfix / $m->isipcsdus);
                ...
                <tr>
                    ...
                    <td>
                        @if (
                            $m->jenis_mutasi == 'REJECT GUDANG' or
                                $m->jenis_mutasi == 'REPACK' or
                                $m->jenis_mutasi == 'PENYESUAIAN' or
                                $m->jenis_mutasi == 'PENYESUAIAN BAD')
                    ...
                    <td align="right" style="background-color: {{ $color_transit_in }}">
                        {{ !empty($transit_in) ? desimal($transit_in) : '' }}</td>
                    <td align="right">{{ !empty($retur) ? desimal($retur) : '' }}</td>
                    <td align="right" style="background-color: {{ $color_lainlain_in }}">
                        {{ !empty($jmllainlain_in) ? desimal($jmllainlain_in) : '' }}</td>
                    ...
                    <td align="right" style="background-color: {{ $color_promosi }}">
                        {{ !empty($promosi) ? desimal($promosi) : '' }}</td>
                    ...
                    <td align="right" style="background-color: {{ $color_transit_out }}">
                        {{ !empty($transit_out) ? desimal($transit_out) : '' }}</td>
                    <td align="right" style="background-color: {{ $color_lainlain_out }}">
                        {{ !empty($jmllainlain_out) ? desimal($jmllainlain_out) : '' }}</td>
