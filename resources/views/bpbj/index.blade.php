...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="/bpbj/store" method="POST" id="frmBpbj">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <x-inputtext field="no_bpbj" label="No. BPBJ" icon="feather icon-credit-card"
                                            readonly />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <x-inputtext field="tgl_mutasi_produksi" label="Tanggal Mutasi Produksi"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <a href="#" class="btn btn-primary" id="tambahbarang"><i
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <x-inputtext label="Tanggal" field="tanggal" icon="feather icon-calendar"
                                            value="{{ Request('tanggal') }}" datepicker />
                                    </div>
                                    <div class="col-4">
                                        <div class="row">
                                            <div class="form-group">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a class="ml-1 detailbpbj" href="#"
                                                        no_mutasi_produksi="{{ Crypt::encrypt($d->no_mutasi_produksi) }}"><i
                                                            class=" feather icon-file-text info"></i></a>
                                                    <form method="POST" class="deleteform"
                                                        action="/bpbj/{{ Crypt::encrypt($d->no_mutasi_produksi) }}/delete">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="#" tanggal="{{ $d->tgl_mutasi_produksi }}"
    ...
    <!-- Detail BPBJ -->
    <div class="modal fade text-left" id="mdldetailbpbj" tabindex="-1" role="dialog" aria-labelledby="myModalLabel18"
        aria-hidden="true">
    ...
    <!-- Pilih Barang  -->
    <div class="modal fade text-left" id="mdlpilihbarang" tabindex="-1" role="dialog"
