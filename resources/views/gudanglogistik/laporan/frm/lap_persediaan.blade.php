...
@section('titlepage','Laporan Persediaan Barang Gudang Logistik')
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Laporan Persediaan Barang Gudang Logistik</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/laporangudanglogistik/persediaan">Laporan Persediaan Barang Gudang Logistik</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="col-lg-9 col-sm-12">
                <div class="row">
                    <div class="col-lg-7 col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="/laporangudanglogistik/persediaan/cetak" method="POST" id="frmLaporan" target="_blank">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
