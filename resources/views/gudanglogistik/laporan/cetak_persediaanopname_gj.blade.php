    ...
    <table class="datatable3" style="width:100%" border="1">
        <thead>
            <tr bgcolor="#024a75">
                ...
                <th bgcolor="#024a75" style="color:white; font-size:14;">KODE BARANG</th>
                <th bgcolor="#024a75" style="color:white; font-size:14;">NAMA BARANG</th>
                <th bgcolor="#024a75" style="color:white; font-size:14;">SATUAN</th>
                <th style="color:white; font-size:14;">SALDO AWAL</th>
                <th style="color:white; font-size:14;">MASUK</th>
                <th style="color:white; font-size:14;">KELUAR</th>
                <th style="color:white; font-size:14;">STOK AKHIR KARTU GUDANG</th>
                <th style="color:white; font-size:14;">OPNAME AKTUAL</th>
                <th style="color:white; font-size:14;">SELISIH</th>
            </tr>
        </thead>
        <tbody>
            <?php
