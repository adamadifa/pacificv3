    ...
    <table class="datatable3" style="width:150%" id="table-1" <?php if ($kategori == "K001") {
        ...
        <thead>
            <tr bgcolor="#024a75">
                ...
                <th <?php if ($kategori == "K001") { echo "colspan='3'";} else {echo "rowspan='2'";} ?> style="color:white; font-size:14;width:180px">SALDO AWAL</th>
                <th <?php if ($kategori == "K001") {echo "colspan='3'";} else {echo "rowspan='2'";} ?> style="color:white; font-size:14;width:180px">MASUK</th>
                <th <?php if ($kategori == "K001") {echo "colspan='3'";} else {echo "rowspan='2'";} ?> style="color:white; font-size:14;width:180px">KELUAR</th>
                <th <?php if ($kategori == "K001") {echo "colspan='3'";} else {echo "rowspan='2'";} ?> style="color:white; font-size:14;width:180px">STOK AKHIR KARTU GUDANG</th>
...
?>
            <tr style="font-size: 12">
                ...
                <?php } ?>
                <!-- Pengeluaran -->
                <td width="70px" align="center"> <?php if (!empty($d->qtypengeluaran) and $d->qtypengeluaran != "0") {echo desimal($d->qtypengeluaran);}?>
                </td>
                <?php if ($kategori == "K001") { ?>
                <td width="90px" align="right"><?php if (!empty($hargakeluar) and $hargakeluar != "0" and !empty($d->qtypengeluaran)) {echo desimal($hargakeluar);}?></td>
                <td width="120px" align="right"><?php if (!empty($jmlhpengeluaran) and $jmlhpengeluaran != "0") {echo desimal($jmlhpengeluaran);}?>
                </td>
                <?php } ?>
                <!-- Stok Akhir -->
                ...
                <?php } ?>
                <!-- Opname -->
                <td width="70px" align="center"><?php if (!empty($d->qtyopname) and $d->qtyopname != "0") { echo desimal($d->qtyopname);}?></td>
                <td width="70px" align="center"><?php if (!empty($selsish) and $selsish != "0") {echo desimal($selsish);}?></td>
            </tr>
            <?php
                }
            ?>
        ...
        <tfoot bgcolor="#024a75" style="color:white; font-size:14;">
            <tr>
                ...
                <?php if ($kategori == "K001") { ?>
                <th align="center"></th>
                <th align="center"><?php if (!empty($totalsaldoawal) and $totalsaldoawal != "0"  and $kode_kategori == "K001") {echo desimal($totalsaldoawal);}?>
                </th>
                <?php } ?>
                <th align="center"><?php if (!empty($totqtymasuk) and $totqtymasuk != "0") {echo desimal($totqtymasuk);}?></th>
                <?php if ($kategori == "K001") { ?>
                <th></th>
                <th align="center"><?php if (!empty($totalpemasukan) and $totalpemasukan != "0" and $kode_kategori == "K001") {echo desimal($totalpemasukan);}?></th>
                <?php } ?>
                <th align="center"><?php if (!empty($totqtykeluar) and $totqtykeluar != "0") {echo desimal($totqtykeluar);}?></th>
                <?php if ($kategori == "K001") { ?>
                <th></th>
                <th align="center"><?php if (!empty($totalpengeluaran) and $totalpengeluaran != "0" and $kode_kategori == "K001") {echo desimal($totalpengeluaran);}?>
                </th>
                <?php } ?>
                <th bgcolor="green" align="center"><?php if (!empty($totqtystokakhir) and $totqtystokakhir != "0") {echo desimal($totqtystokakhir);}?>
                </th>
                <?php if ($kategori == "K001") { ?>
                <th></th>
                <th bgcolor="green" align="center"><?php if (!empty($totstokakhir) and $totstokakhir != "0" and $kode_kategori == "K001") {echo desimal($totstokakhir);}?>
                </th>
                <?php } ?>
                <th align="center"><?php if (!empty($totalopname) and $totalopname != "0") {echo desimal($totalopname);}?>
                </th>
                <th align="center"><?php if (!empty($totalselisih) and $totalselisih != "0") {echo desimal($totalselisih);}?>
                </th>
            </tr>
        </tfoot>
    </table>
