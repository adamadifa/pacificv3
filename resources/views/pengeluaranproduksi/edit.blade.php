...
<div class="content-wrapper">
    ...
    <div class="content-body">
        ...
        <form action="/pengeluaranproduksi/{{ Crypt::encrypt($pengeluaranproduksi->nobukti_pengeluaran) }}/update" method="POST" id="frmBarangkeluarproduksi">
            @csrf
                ...
                <div class="col-lg-4 col-sm-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <input type="hidden" value="{{ Crypt::encrypt($pengeluaranproduksi->nobukti_pengeluaran) }}" id="no_bukti">
                                    <x-inputtext field="nobukti_pengeluaran" label="Auto" icon="feather icon-credit-card" value="{{ $pengeluaranproduksi->nobukti_pengeluaran }}" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <x-inputtext field="tgl_pengeluaran" value="{{ $pengeluaranproduksi->tgl_pengeluaran }}" label="Tanggal pengeluaran" icon="feather icon-calendar" datepicker />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <select name="kode_dept" id="kode_dept" class="form-control">
                                            ...
                                            <option {{ $pengeluaranproduksi->kode_dept == "Pemakaian" ? "selected" : ""}} value="Pemakaian">Pemakaian</option>
                                            <option {{ $pengeluaranproduksi->kode_dept == "Retur Out" ? "selected" : ""}} value="Retur Out">Retur Out</option>
                                            <option {{ $pengeluaranproduksi->kode_dept == "Lainnya" ? "selected" : ""}} value="Lainnya">Lainnya</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <select name="kode_supplier" id="kode_supplier" class="form-control">
                                            ...
                                            <option {{ $pengeluaranproduksi->kode_supplier == "SP0186" ? "selected" : ""}} value="SP0186">SURYA BUANA CV</option>
                                            <option {{ $pengeluaranproduksi->kode_supplier == "SP0142" ? "selected" : ""}} value="SP0142">PT PURINUSA EKA PERSADA</option>
                                            <option {{ $pengeluaranproduksi->kode_supplier == "SP0185" ? "selected" : ""}} value="SP0185">SAKU MAS JAYA, PT</option>
                                            <option {{ $pengeluaranproduksi->kode_supplier == "SP0140" ? "selected" : ""}} value="SP0140">PT MULIAPACK GRAVURINDO</option>
                                            <option {{ $pengeluaranproduksi->kode_supplier == "SP0032" ? "selected" : ""}} value="SP0032">PT EKADHARMA INTERNATIONAL</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
    ...
    $(function() {
        ...
        $("#tambahbarang").click(function(e) {
            ...
            if (kode_barang == "") {
                ...
                $.ajax({
                    type: 'POST'
                    , url: '/pengeluaranproduksi/storebarang'
                    , data: {
                        _token: "{{ csrf_token() }}"
                        , nobukti_pengeluaran: nobukti_pengeluaran
