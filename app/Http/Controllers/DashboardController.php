...
class DashboardController extends Controller
{
    ...
    public function home()
    {
        ...
        } else if (Auth::user()->level == "kepala gudang" || Auth::user()->level == "admin gudang pusat" || Auth::user()->level == "emf" || Auth::user()->level == "admin produksi" || Auth::user()->level == "manager produksi") {
