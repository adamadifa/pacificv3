    ...
    public function cetakpresensi(Request $request)
    {
        ...
        $query->leftJoin(
            DB::raw("(
                ...
                FROM bpjs_kesehatan a WHERE tgl_berlaku = (SELECT MAX(tgl_berlaku) as tgl_berlaku FROM bpjs_kesehatan b WHERE a.nik = b.nik AND b.tgl_berlaku <= '$berlakugaji')
            ) bpjs_kesehatan"),
            function ($join) {
        ...
        $query->leftJoin(
            DB::raw("(
                ...
                FROM bpjs_tenagakerja a WHERE tgl_berlaku = (SELECT MAX(tgl_berlaku) as tgl_berlaku FROM bpjs_tenagakerja b WHERE a.nik = b.nik AND b.tgl_berlaku <= '$berlakugaji')
            ) bpjs_tenagakerja"),
            function ($join) {
        ...
        if (request()->is('laporanhrd/presensipsm/cetak')) {
            if (isset($_POST['export'])) {
                ...
                return view('presensi.laporan.cetak_psmexcel', compact('departemen', 'kantor', 'group', 'namabulan', 'bulan', 'tahun', 'jmlrange', 'rangetanggal', 'presensi', 'datalibur', 'dataliburpenggantiminggu', 'dataminggumasuk', 'datawfh', 'datawfhfull', 'datalembur'));
            } else {
                return view('presensi.laporan.cetakpsm', compact('departemen', 'kantor', 'group', 'namabulan', 'bulan', 'tahun', 'jmlrange', 'rangetanggal', 'presensi', 'datalibur', 'dataliburpenggantiminggu', 'dataminggumasuk', 'datawfh', 'datawfhfull', 'datalembur'));
            }
