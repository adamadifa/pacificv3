...
class BpbjController extends Controller
{
    ...
    public function storetemp(Request $request)
    {
        ...
        $cek = DB::table('detail_mutasi_produksi_temp')->where('kode_produk', $kode_produk)->where('shift', $shift)->where('id_admin', $id_admin)->count();
        $data = [
    ...
    public function cekbpbjtemp(Request $request)
    {
        $kode_produk = $request->kode_produk;
        $id_admin = Auth::user()->id;
        $cek = DB::table('detail_mutasi_produksi_temp')->where('kode_produk', $kode_produk)->where('id_admin', $id_admin)->count();
        echo $cek;
    }
    ...
    public function store(Request $request)
    {
        ...
        $detailtemp = DB::table('detail_mutasi_produksi_temp')->where('kode_produk', $kode_produk)->where('id_admin', $id_admin)->get();
        DB::beginTransaction();
        try {
            $data = [
            ...
            DB::table('detail_mutasi_produksi_temp')->where('kode_produk', $kode_produk)->where('id_admin', $id_admin)->delete();
            DB::commit();
