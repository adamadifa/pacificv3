    ...
    public function boot(Guard $auth)
    {
        ...
        view()->composer('*', function ($view) use ($auth) {
            ...
            $laporan_penjualan = [
                ...
                'staff keuangan 3', 'audit', 'manager audit', 'admin pajak', 'admin pajak 2', 'admin medsos', 'admin garut', 'admin gudang cabang', 'admin penjualan dan persediaan', 'manager accounting', 'rom', 'kepala gudang'
            ];
            $harga_net = [
