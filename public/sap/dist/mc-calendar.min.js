        ...
        var e = {
            422: (e, t, n) => {
                ...
                var a = {
                    ...
                    weekday: { foreground: "#ad3838" },
                    button: {
                        success: { foreground: "#ad3838" },
                ...
                var i = "show-calendar",
                    ...
                    g = function (e) {
                        e.dispatchEvent(
                            new CustomEvent(u, { bubbles: !0 })
                        );
                    },
                    b = function (e) {
                        e.dispatchEvent(
                            new CustomEvent(s, { bubbles: !0 })
                        );
                    },
                    _ = function (e) {
                        var t =
                    ...
                    x = function (e) {
                        ...
                        e.dispatchEvent(
                            new CustomEvent(p, { bubbles: !0, detail: t })
                        );
                    },
                    M = function (e) {
                        e.dispatchEvent(
                            new CustomEvent(y, { bubbles: !0 })
                        );
                    };
                ...
                var W = function (e) {
                        ...
                        date: function (e) {
                            var t = z(["active", "inactive", "marcked"], e),
                                n = Object.keys(e).every(function (t) {
                                    var n = e[t],
                                        a = z(
                                            ["default", "picked", "today"],
                                            n
                                        );
                                    if ("marcked" === t)
                                        return J(["foreground"], n);
                                    var r = Object.keys(n).every(function (
                                        e
                                    ) {
                                        return J(
                                            "default" === e
                    ...
                    Z = function (e, t) {
                        ...
                        return (
                            ...
                            n.push(
                                new Error(
                                    "maxDate should be greater than minDate"
                                )
                            ),
                            ...
                            i = function (t) {
                                ...
                                return (
                                    ...
                                    !(function (e, t) {
                                        ...
                                        ? (r.push("mc-date--inactive"),
                                            (t.tabindex = -1))
                                        : (r.push("mc-date--active"),
                                            (t.tabindex = 0)),
                                    (function (e, t) {
                                        var n = t.date;
                ...
                var se = function (e) {
                    return {
                        ...
                        displayDate:
                            e.querySelector(".mc-display__date"),
                        displayMonth:
                            e.querySelector(".mc-display__month"),
                        displayYear:
                            e.querySelector(".mc-display__year"),
                        accessibilityMonthYear: e.querySelector(
                            "#mc-picker__month-year"
                        ),
                        calendarHeader:
                            e.querySelector(".mc-picker__header"),
                        currentMonthSelect:
                            e.querySelector("#mc-current--month"),
                        currentYearSelect:
                            e.querySelector("#mc-current--year"),
                        monthNavPrev: e.querySelector(
                            "#mc-picker__month--prev"
                        ),
                        monthNavNext: e.querySelector(
                            "#mc-picker__month--next"
                        ),
                        yearNavPrev: e.querySelector(
                            "#mc-picker__year--prev"
                        ),
                        yearNavNext: e.querySelector(
                            "#mc-picker__year--next"
                        ),
                        weekdays:
                            e.querySelectorAll(".mc-table__weekday"),
                        okButton: e.querySelector("#mc-btn__ok"),
                        cancelButton:
                            e.querySelector("#mc-btn__cancel"),
                        clearButton: e.querySelector("#mc-btn__clear"),
                        dateCells: e.querySelectorAll(".mc-date"),
                        monthYearPreview: e.querySelector(
                            ".mc-month-year__preview"
                        ),
                        previewCells: e.querySelectorAll(
                            ".mc-month-year__cell"
                        ),
                        calendarStates: A(e),
                    };
                    ...
                    var r =
                        ...
                        i = (function (e) {
                            var t = e.minDate,
                                ...
                                l = i[i.length - 1],
                                d = a.length
                                    ? Math.min.apply(Math, le(a))
                                    : null,
                                s = a.length
                                    ? Math.max.apply(Math, le(a))
                                    : null,
